...
interpret(Goal) :-
    true((mshare([[Goal],[Rest]]),var(Rest),linear(Rest);mshare([[Rest]]),var(Rest),ground([Goal]),linear(Rest))),
    interpret(Goal,Rest),
...
:- true pred interpret(G,_1)
   : ( mshare([[_1]]),
       var(_1), ground([G]), linear(_1) )
   => ( mshare([[_1]]),
        ground([G]) ).

interpret(G,_1) :-
    true((mshare([[G],[_1]]),var(_1),linear(_1);mshare([[_1]]),var(_1),ground([G]),linear(_1))),
    var(G),
    !,
    true((fails(_);mshare([[G],[_1]]),var(G),var(_1),linear(G),linear(_1))),
    fail,
    true(fails(_)).
interpret((A,B),Rest) :-
    !,
    true((mshare([[Rest],[A],[A,B],[B],[Rest0]]),var(Rest),var(Rest0),linear(Rest),linear(Rest0);mshare([[Rest],[Rest0]]),var(Rest),var(Rest0),ground([A,B]),linear(Rest),linear(Rest0))),
    interpret(A,Rest0),
    true((mshare([[Rest],[A],[A,B],[A,B,Rest0],[A,Rest0],[B],[Rest0]]),var(Rest),linear(Rest);mshare([[Rest],[Rest0]]),var(Rest),ground([A,B]),linear(Rest))),
...
interpret((A;B),Rest) :-
    !,
    true((mshare([[Rest]]),var(Rest),ground([A,B]),linear(Rest);mshare([[Rest],[A],[A,B],[B]]),var(Rest),linear(Rest))),
...
interpret(\+A,Rest) :-
    !,
    true((mshare([[Rest]]),var(Rest),ground([A]),linear(Rest);mshare([[Rest],[A]]),var(Rest),linear(Rest))),
...
interpret(G,_1) :-
    true((mshare([[G],[_1],[Body]]),var(_1),var(Body),linear(_1),linear(Body);mshare([[_1],[Body]]),var(_1),var(Body),ground([G]),linear(_1),linear(Body))),
    define(G,Body),
    true((mshare([[G],[G,Body],[_1],[Body]]),var(_1),linear(_1);mshare([[_1],[Body]]),var(_1),ground([G]),linear(_1))),
    interpret(Body),
    true((mshare([[G],[G,Body],[_1],[Body]]),var(_1),linear(_1);mshare([[_1],[Body]]),var(_1),ground([G]),linear(_1))).

:- true pred 'interpret/2/2/$disj/1'(Rest,B,Rest0)
   : ( mshare([[Rest],[Rest0]]),
       var(Rest), ground([B]), linear(Rest) )
   => ( mshare([[Rest],[Rest,Rest0],[Rest0]]),
        ground([B]) ).

:- true pred 'interpret/2/2/$disj/1'(Rest,B,Rest0)
   : ( mshare([[Rest],[B],[Rest0]]),
       var(Rest), linear(Rest) )
...
'interpret/2/2/$disj/1'(Rest,B,Rest0) :-
    true((mshare([[Rest],[B],[B,Rest0],[Rest0]]),var(Rest),linear(Rest);mshare([[Rest],[B],[Rest0]]),var(Rest),linear(Rest);mshare([[Rest],[Rest0]]),var(Rest),ground([B]),linear(Rest))),
    nonvar(Rest0),
    !,
    true((mshare([[Rest],[B],[B,Rest0],[Rest0]]),var(Rest),linear(Rest);mshare([[Rest],[B],[Rest0]]),var(Rest),linear(Rest);mshare([[Rest],[Rest0]]),var(Rest),ground([B]),linear(Rest))),
    Rest=(Rest0,B),
...
:- true pred interpret_disjunction(A,_1,Rest)
   : ( mshare([[Rest]]),
       var(Rest), ground([A,_1]), linear(Rest) )
   => ( mshare([[Rest]]),
        ground([A,_1]) ).
...
:- true pred interpret_disjunction(A,_1,Rest)
   : ( (A=(_A->_B)), (_1=fail),
       mshare([[Rest]]),
       var(Rest), ground([_A,_B]), linear(Rest) )
   => ( mshare([[Rest]]),
        ground([_A,_B]) ).
...
:- true pred interpret_disjunction(A,_1,Rest)
   : ( (A=(_A->fail)), (_1=true),
       mshare([[Rest]]),
       var(Rest), ground([_A]), linear(Rest) )
   => ( mshare([[Rest]]),
        ground([_A]) ).
...
interpret_disjunction((A->B),_1,Rest) :-
    true((mshare([[_1],[_1,A],[_1,A,B],[_1,B],[Rest],[A],[A,B],[B],[Rest0]]),var(Rest),var(Rest0),linear(Rest),linear(Rest0);mshare([[Rest],[A],[A,B],[B],[Rest0]]),var(Rest),var(Rest0),ground([_1]),linear(Rest),linear(Rest0);mshare([[Rest],[A],[Rest0]]),var(Rest),var(Rest0),ground([_1,B]),linear(Rest),linear(Rest0);mshare([[Rest],[Rest0]]),var(Rest),var(Rest0),ground([_1,A,B]),linear(Rest),linear(Rest0))),
    interpret(A,Rest0),
    !,
    true((mshare([[_1],[_1,A],[_1,A,B],[_1,A,B,Rest0],[_1,A,Rest0],[_1,B],[Rest],[A],[A,B],[A,B,Rest0],[A,Rest0],[B],[Rest0]]),var(Rest),linear(Rest);mshare([[Rest],[A],[A,B],[A,B,Rest0],[A,Rest0],[B],[Rest0]]),var(Rest),ground([_1]),linear(Rest);mshare([[Rest],[A],[A,Rest0],[Rest0]]),var(Rest),ground([_1,B]),linear(Rest);mshare([[Rest],[Rest0]]),var(Rest),ground([_1,A,B]),linear(Rest))),
...
interpret_disjunction((_1->_2),C,Rest) :-
    !,
    true((mshare([[C],[C,_1],[C,_1,_2],[C,_2],[Rest],[_1],[_1,_2],[_2]]),var(Rest),linear(Rest);mshare([[Rest]]),var(Rest),ground([C,_1,_2]),linear(Rest);mshare([[Rest],[_1]]),var(Rest),ground([C,_2]),linear(Rest);mshare([[Rest],[_1],[_1,_2],[_2]]),var(Rest),ground([C]),linear(Rest))),
    interpret(C,Rest),
...
interpret_disjunction(A,_1,Rest) :-
    true((mshare([[A],[A,_1],[_1],[Rest]]),var(Rest),linear(Rest);mshare([[A],[Rest]]),var(Rest),ground([_1]),linear(Rest);mshare([[Rest]]),var(Rest),ground([A,_1]),linear(Rest))),
    interpret(A,Rest),
...
interpret_disjunction(_1,B,Rest) :-
    true((mshare([[_1],[_1,B],[B],[Rest]]),var(Rest),linear(Rest);mshare([[_1],[Rest]]),var(Rest),ground([B]),linear(Rest);mshare([[Rest]]),var(Rest),ground([_1,B]),linear(Rest))),
    interpret(B,Rest),
...
'interpret_disjunction/3/1/$disj/1'(Rest,B,Rest0) :-
    true((mshare([[Rest],[B],[B,Rest0],[Rest0]]),var(Rest),linear(Rest);mshare([[Rest],[Rest0]]),var(Rest),ground([B]),linear(Rest))),
    nonvar(Rest0),
    !,
    true((mshare([[Rest],[B],[B,Rest0],[Rest0]]),var(Rest),linear(Rest);mshare([[Rest],[Rest0]]),var(Rest),ground([B]),linear(Rest))),
    Rest=(Rest0->B),
