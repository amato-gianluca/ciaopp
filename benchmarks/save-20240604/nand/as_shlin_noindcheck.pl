...
:- true pred select_vector(_A,NumVars,_1,_2,Gj,V,Type,N,GjOut,Vout,TypeOut,Nout)
   : ( (_A=_2), (Gj=dummy), (V=0), (Type=nf), (N=999),
       ...
       ground([_A,NumVars,_1]), linear(GjOut), linear(Vout), linear(TypeOut), linear(Nout) )
   => ground([_A,NumVars,_1,GjOut,Vout,TypeOut,Nout]).

:- true pred select_vector(_A,NumVars,_1,_2,Gj,V,Type,N,GjOut,Vout,TypeOut,Nout)
   : ( mshare([[GjOut],[Vout],[TypeOut],[Nout]]),
       ground([_A,NumVars,_1,_2,Gj,V,Type,N]), linear(GjOut), linear(Vout), linear(TypeOut), linear(Nout) )
...
:- true pred select_vector(_A,_1,_2,_3,_4,Gj,V,Type,N,GjOut,Vout,TypeOut,Nout)
   : ( (Gj=dummy), (V=0), (Type=nf), (N=999),
       ...
       ground([_A,_1,_2,_3,_4,TypeOut]), linear(GjOut), linear(Vout), linear(Nout) )
   => ground([_A,_1,_2,_3,_4,GjOut,Vout,TypeOut,Nout]).

:- true pred select_vector(_A,_1,_2,_3,_4,Gj,V,Type,N,GjOut,Vout,TypeOut,Nout)
   : ( mshare([[GjOut],[Vout],[Nout]]),
       ground([_A,_1,_2,_3,_4,Gj,V,Type,N,TypeOut]), linear(GjOut), linear(Vout), linear(Nout) )
   => ground([_A,_1,_2,_3,_4,Gj,V,Type,N,GjOut,Vout,TypeOut,Nout]).
...
:- true pred cover_type1(_A,_1,_2,T,N,TypeOut,Nout)
   : ( mshare([[TypeOut],[Nout]]),
       ground([_A,_1,_2,T,N]), linear(TypeOut), linear(Nout) )
...
:- true pred cover_type2(_A,_1,_2,_3,_4,T,N,TypeOut,Nout)
   : ( mshare([[TypeOut],[Nout]]),
       ground([_A,_1,_2,_3,_4,T,N]), linear(TypeOut), linear(Nout) )
...
:- true pred 'cover_type2/9/3/$disj/2/6/1/$disj/1'(Fj,TypeIn,Ti,Type)
   : ( mshare([[Type]]),
       ground([Fj,TypeIn,Ti]), linear(Type) )
...
:- true pred cover_vector(_A,_B,_1,Gj,V,_2,NumGs,GsIn,NumGsOut,GsOut)
   : ( mshare([[NumGsOut],[GsOut]]),
       ground([_A,_B,_1,Gj,V,_2,NumGs,GsIn]), linear(NumGsOut), linear(GsOut) )
   => ground([_A,_B,_1,Gj,V,_2,NumGs,GsIn,NumGsOut,GsOut]).

:- true pred cover_vector(_A,_B,_1,Gj,V,_2,NumGs,GsIn,NumGsOut,GsOut)
   : ( (_A=exmcf), (NumGs=NumGsOut),
       mshare([[_B],[GsOut]]),
       ground([_1,Gj,V,_2,NumGs,GsIn]), linear(_B), linear(GsOut) )
   => ( mshare([[_B]]),
        ground([_1,Gj,V,_2,NumGs,GsIn,GsOut]), linear(_B) ).
...
:- true pred cover_vector(_A,_B,_1,Gj,V,_2,NumGs,GsIn,NumGsOut,GsOut)
   : ( (_A=exp), (NumGs=NumGsOut),
       mshare([[_1],[GsOut]]),
       ground([_B,Gj,V,_2,NumGs,GsIn]), linear(_1), linear(GsOut) )
   => ( mshare([[_1]]),
        ground([_B,Gj,V,_2,NumGs,GsIn,GsOut]), linear(_1) ).

cover_vector(exp,[I|_3],_1,Gj,V,_2,NumGs,GsIn,NumGs,GsOut) :-
    true((mshare([[_1],[GsOut],[Gi],[Ti]]),ground([Gj,V,_2,NumGs,GsIn,I,_3]),linear(_1),linear(GsOut),linear(Gi),linear(Ti);mshare([[GsOut],[Gi],[Ti]]),ground([_1,Gj,V,_2,NumGs,GsIn,I,_3]),linear(GsOut),linear(Gi),linear(Ti))),
    function(I,GsIn,Gi),
    true((mshare([[_1],[GsOut],[Ti]]),ground([Gj,V,_2,NumGs,GsIn,I,_3,Gi]),linear(_1),linear(GsOut),linear(Ti);mshare([[GsOut],[Ti]]),ground([_1,Gj,V,_2,NumGs,GsIn,I,_3,Gi]),linear(GsOut),linear(Ti))),
    true_set(Gi,Ti),
    true((mshare([[_1],[GsOut]]),ground([Gj,V,_2,NumGs,GsIn,I,_3,Gi,Ti]),linear(_1),linear(GsOut);mshare([[GsOut]]),ground([_1,Gj,V,_2,NumGs,GsIn,I,_3,Gi,Ti]),linear(GsOut))),
    'cover_vector/10/1/$disj/1'(V,Ti),
    true((mshare([[_1],[GsOut]]),ground([Gj,V,_2,NumGs,GsIn,I,_3,Gi,Ti]),linear(_1),linear(GsOut);mshare([[GsOut]]),ground([_1,Gj,V,_2,NumGs,GsIn,I,_3,Gi,Ti]),linear(GsOut))),
    update_circuit(GsIn,Gi,Gj,V,GsIn,GsOut),
    true((mshare([[_1]]),ground([Gj,V,_2,NumGs,GsIn,GsOut,I,_3,Gi,Ti]),linear(_1);ground([_1,Gj,V,_2,NumGs,GsIn,GsOut,I,_3,Gi,Ti]))).
cover_vector(exp,[_2|IPs],_1,Gj,V,NumVars,NumGs,GsIn,NumGs,GsOut) :-
    true((mshare([[_1],[GsOut],[_3]]),ground([Gj,V,NumVars,NumGs,GsIn,_2,IPs]),linear(_1),linear(GsOut),linear(_3);mshare([[GsOut],[_3]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,_2,IPs]),linear(GsOut),linear(_3))),
    cover_vector(exp,IPs,_3,Gj,V,NumVars,NumGs,GsIn,NumGs,GsOut),
    true((mshare([[_1],[_3]]),ground([Gj,V,NumVars,NumGs,GsIn,GsOut,_2,IPs]),linear(_1),linear(_3);mshare([[_3]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,GsOut,_2,IPs]),linear(_3))).
cover_vector(var,_1,[I|_2],Gj,V,NumVars,NumGs,GsIn,NumGs,GsOut) :-
    true((mshare([[_1],[GsOut],[Gi],[Fi]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(_1),linear(GsOut),linear(Gi),linear(Fi);mshare([[GsOut],[Gi],[Fi]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(GsOut),linear(Gi),linear(Fi))),
    I<NumVars,
    true((mshare([[_1],[GsOut],[Gi],[Fi]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(_1),linear(GsOut),linear(Gi),linear(Fi);mshare([[GsOut],[Gi],[Fi]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(GsOut),linear(Gi),linear(Fi))),
    function(I,GsIn,Gi),
    true((mshare([[_1],[GsOut],[Fi]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2,Gi]),linear(_1),linear(GsOut),linear(Fi);mshare([[GsOut],[Fi]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2,Gi]),linear(GsOut),linear(Fi))),
    false_set(Gi,Fi),
    true((mshare([[_1],[GsOut]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi]),linear(_1),linear(GsOut);mshare([[GsOut]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi]),linear(GsOut))),
    set_member(V,Fi),
    true((mshare([[_1],[GsOut]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi]),linear(_1),linear(GsOut);mshare([[GsOut]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi]),linear(GsOut))),
    update_circuit(GsIn,Gi,Gj,V,GsIn,GsOut),
    true((mshare([[_1]]),ground([Gj,V,NumVars,NumGs,GsIn,GsOut,I,_2,Gi,Fi]),linear(_1);ground([_1,Gj,V,NumVars,NumGs,GsIn,GsOut,I,_2,Gi,Fi]))).
cover_vector(var,_1,[_2|CIs],Gj,V,NumVars,NumGs,GsIn,NumGs,GsOut) :-
    true((mshare([[_1],[GsOut],[_3]]),ground([Gj,V,NumVars,NumGs,GsIn,_2,CIs]),linear(_1),linear(GsOut),linear(_3);mshare([[GsOut],[_3]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,_2,CIs]),linear(GsOut),linear(_3))),
    cover_vector(var,_3,CIs,Gj,V,NumVars,NumGs,GsIn,NumGs,GsOut),
    true((mshare([[_1],[_3]]),ground([Gj,V,NumVars,NumGs,GsIn,GsOut,_2,CIs]),linear(_1),linear(_3);mshare([[_3]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,GsOut,_2,CIs]),linear(_3))).
cover_vector(fcn,_1,[I|_2],Gj,V,NumVars,NumGs,GsIn,NumGs,GsOut) :-
    true((mshare([[_1],[GsOut],[Gi],[Fi],[Ti],[Fj]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(_1),linear(GsOut),linear(Gi),linear(Fi),linear(Ti),linear(Fj);mshare([[GsOut],[Gi],[Fi],[Ti],[Fj]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(GsOut),linear(Gi),linear(Fi),linear(Ti),linear(Fj))),
    I>=NumVars,
    true((mshare([[_1],[GsOut],[Gi],[Fi],[Ti],[Fj]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(_1),linear(GsOut),linear(Gi),linear(Fi),linear(Ti),linear(Fj);mshare([[GsOut],[Gi],[Fi],[Ti],[Fj]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(GsOut),linear(Gi),linear(Fi),linear(Ti),linear(Fj))),
    function(I,GsIn,Gi),
    true((mshare([[_1],[GsOut],[Fi],[Ti],[Fj]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2,Gi]),linear(_1),linear(GsOut),linear(Fi),linear(Ti),linear(Fj);mshare([[GsOut],[Fi],[Ti],[Fj]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2,Gi]),linear(GsOut),linear(Fi),linear(Ti),linear(Fj))),
    false_set(Gi,Fi),
    true((mshare([[_1],[GsOut],[Ti],[Fj]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi]),linear(_1),linear(GsOut),linear(Ti),linear(Fj);mshare([[GsOut],[Ti],[Fj]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi]),linear(GsOut),linear(Ti),linear(Fj))),
    set_member(V,Fi),
    true((mshare([[_1],[GsOut],[Ti],[Fj]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi]),linear(_1),linear(GsOut),linear(Ti),linear(Fj);mshare([[GsOut],[Ti],[Fj]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi]),linear(GsOut),linear(Ti),linear(Fj))),
    true_set(Gi,Ti),
    true((mshare([[_1],[GsOut],[Fj]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi,Ti]),linear(_1),linear(GsOut),linear(Fj);mshare([[GsOut],[Fj]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi,Ti]),linear(GsOut),linear(Fj))),
    false_set(Gj,Fj),
    true((mshare([[_1],[GsOut]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi,Ti,Fj]),linear(_1),linear(GsOut);mshare([[GsOut]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi,Ti,Fj]),linear(GsOut))),
    set_subset(Fj,Ti),
    true((mshare([[_1],[GsOut]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi,Ti,Fj]),linear(_1),linear(GsOut);mshare([[GsOut]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2,Gi,Fi,Ti,Fj]),linear(GsOut))),
    update_circuit(GsIn,Gi,Gj,V,GsIn,GsOut),
    true((mshare([[_1]]),ground([Gj,V,NumVars,NumGs,GsIn,GsOut,I,_2,Gi,Fi,Ti,Fj]),linear(_1);ground([_1,Gj,V,NumVars,NumGs,GsIn,GsOut,I,_2,Gi,Fi,Ti,Fj]))).
...
:- true pred add_necessary_functions(NumGs,_1,NumGsIn,Gs,NumGsOut,GsOut)
   : ( (NumGs=_1),
       mshare([[NumGsOut],[GsOut]]),
       ground([NumGs,NumGsIn,Gs]), linear(NumGsOut), linear(GsOut) )
   => ground([NumGs,NumGsIn,Gs,NumGsOut,GsOut]).

:- true pred add_necessary_functions(NumGs,_1,NumGsIn,Gs,NumGsOut,GsOut)
   : ( mshare([[NumGsOut],[GsOut]]),
       ground([NumGs,_1,NumGsIn,Gs]), linear(NumGsOut), linear(GsOut) )
...
:- true pred new_function_CIs(_A,_1,_2,_3,_B,CIl,CIlOut)
   : ( mshare([[_B],[CIlOut]]),
       ground([_A,_1,_2,_3,CIl]), linear(_B), linear(CIlOut) )
   => ground([_A,_1,_2,_3,_B,CIl,CIlOut]).

:- true pred new_function_CIs(_A,_1,_2,_3,_B,CIl,CIlOut)
   : ( (CIl=[_C|_D]),
       mshare([[_B],[CIlOut]]),
       ground([_A,_1,_2,_3,_C,_D]), linear(_B), linear(CIlOut) )
...
update_bounds(_1,NumGs,_2) :-
    true((mshare([[_1],[_2]]),ground([NumGs]),linear(_1),linear(_2);ground([_1,NumGs,_2]))),
    set(bound,NumGs),
    true((mshare([[_1],[_2]]),ground([NumGs]),linear(_1),linear(_2);ground([_1,NumGs,_2]))).
...
:- true pred set_difference(_A,_B,L3)
   : ( (_B=[_C]),
       mshare([[L3]]),
       ground([_A,_C]), linear(L3) )
   => ground([_A,L3,_C]).

:- true pred set_difference(_A,_B,L3)
   : ( (_A=[_C|_D]),
       mshare([[L3]]),
       ground([_B,_C,_D]), linear(L3) )
   => ground([_B,L3,_C,_D]).

:- true pred set_difference(_A,_B,L3)
   : ( (_B=[_C|_D]),
       mshare([[L3]]),
       ground([_A,_C,_D]), linear(L3) )
   => ground([_A,L3,_C,_D]).

:- true pred set_difference(_A,_B,L3)
   : ( mshare([[L3]]),
       ground([_A,_B]), linear(L3) )
   => ground([_A,_B,L3]).
