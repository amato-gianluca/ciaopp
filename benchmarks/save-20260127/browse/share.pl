...
init(N,I,M,Npats,Ipats,[Symb|Rest]) :-
    true((
        mshare([[Symb],[Symb,Rest],[Rest],[L],[Ppats],[J],[N1],[I1]]),
        ground([N,I,M,Npats,Ipats])
    )),
    fill(I,[],L),
    true((
        mshare([[Symb],[Symb,Rest],[Rest],[Ppats],[J],[N1],[I1]]),
        ground([N,I,M,Npats,Ipats,L])
    )),
    get_pats(Npats,Ipats,Ppats),
    true((
        mshare([[Symb],[Symb,Rest],[Rest],[J],[N1],[I1]]),
        ground([N,I,M,Npats,Ipats,L,Ppats])
    )),
    J is M-I,
    true((
        mshare([[Symb],[Symb,Rest],[Rest],[N1],[I1]]),
...
randomize(In,[X|Out],Rand) :-
    true((mshare([[In],[In,X],[In,X,Out],[In,Out],[X],[X,Out],[Out],[Lin],[Rand1],[N],[In1]]),ground([Rand]);mshare([[In],[X],[X,Out],[Out],[Lin],[Rand1],[N],[In1]]),ground([Rand]))),
...
split(N,[X|Xs],RemovedElt,[X|Ys]) :-
    true((mshare([[RemovedElt],[RemovedElt,X],[RemovedElt,X,Xs],[RemovedElt,X,Xs,Ys],[RemovedElt,X,Ys],[RemovedElt,Xs],[RemovedElt,Xs,Ys],[RemovedElt,Ys],[X],[X,Xs],[X,Xs,Ys],[X,Ys],[Xs],[Xs,Ys],[Ys],[N1]]),ground([N]);mshare([[RemovedElt],[RemovedElt,X],[RemovedElt,X,Xs],[RemovedElt,X,Xs,Ys],[RemovedElt,X,Ys],[RemovedElt,Xs],[X],[X,Xs],[X,Xs,Ys],[X,Ys],[Xs],[Ys],[N1]]),ground([N]);mshare([[RemovedElt],[X],[X,Xs],[X,Xs,Ys],[X,Ys],[Xs],[Xs,Ys],[Ys],[N1]]),ground([N]);mshare([[RemovedElt],[X],[X,Xs],[X,Xs,Ys],[X,Ys],[Xs],[Ys],[N1]]),ground([N]))),
    N1 is N-1,
...
investigate([U|Units],Patterns) :-
    true(mshare([[Patterns],[U],[U,Units],[Units],[Data]])),
...
match(List,[Y|Rest]) :-
    true((mshare([[List],[List,Y],[List,Y,Rest],[List,Rest],[Y],[Y,Rest],[Rest],[X],[SRest]]);mshare([[List],[Y],[Y,Rest],[Rest],[X],[SRest]]))),
    nonvar(Y),
    true((mshare([[List],[List,Y],[List,Y,Rest],[List,Rest],[Y],[Y,Rest],[Rest],[X],[SRest]]);mshare([[List],[Y],[Y,Rest],[Rest],[X],[SRest]]))),
    Y=star(X),
    !,
    true((mshare([[List],[List,Y,Rest,X],[List,Y,X],[List,Rest],[Y,Rest,X],[Y,X],[Rest],[SRest]]);mshare([[List],[Y,Rest,X],[Y,X],[Rest],[SRest]]))),
    '$concat'(X,SRest,List),
...
'$concat'([],L,L).
'$concat'([X|L1],L2,[X|L3]) :-
    true((mshare([[L2],[X],[X,L1],[X,L1,L3],[X,L3],[L1],[L1,L3],[L3]]);mshare([[L2],[X],[X,L1],[X,L1,L3],[X,L3],[L1],[L3]]))),
    '$concat'(L1,L2,L3),
