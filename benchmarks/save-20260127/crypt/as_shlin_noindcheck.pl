...
:- true pred sum(AL,BL,CL)
   : ( (AL=[_A,_B,_C,_D]), (BL=[0,_E,_F,_G]), (CL=[_H,_I,_J,_K|_L]),
       ...
       ground([_A,_B,_C,_D,_E,_F,_G]), linear(_H), linear(_I), linear(_J), linear(_K), linear(_L) )
...
:- true pred mult(AL,D,BL)
   : ( (AL=[_A,_B,_C]), (BL=[_D,_E,_F|_G]),
       mshare([[_D],[_E],[_F],[_G]]),
       ground([D,_A,_B,_C]), linear(_D), linear(_E), linear(_F), linear(_G) )
   => ground([D,_A,_B,_C,_D,_E,_F,_G]).

:- true pred mult(AL,D,BL)
   : ( (AL=[_A,_B,_C]), (BL=[_D,_E,_F,_G|_H]),
       mshare([[_D],[_E],[_F],[_G],[_H]]),
       ground([D,_A,_B,_C]), linear(_D), linear(_E), linear(_F), linear(_G), linear(_H) )
