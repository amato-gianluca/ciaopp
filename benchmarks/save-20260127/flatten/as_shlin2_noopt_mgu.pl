...
copy2(V1,V2,Sym) :-
    ...
    var(V1),
    !,
    true((mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),linear(V1),shlin2([([V1],[V1]),([V1,V2,Sym],[V1]),([V1,Sym],[V1]),([V2],[V1]),([V2,Sym],[V1]),([Sym],[V1])]);mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),linear(V1),shlin2([([V1],[V1]),([V1,V2,Sym],[V1]),([V1,Sym],[V1]),([V2],[V1,V2]),([V2,Sym],[V1]),([Sym],[V1])]);mshare([[V1],[V1,Sym],[V2],[Sym]]),linear(V1),linear(V2),shlin2([([V1],[V1]),([V1,Sym],[V1]),([V2],[V1,V2]),([Sym],[V1,Sym])]);mshare([[V1,V2,Sym],[V1,Sym],[V2,Sym],[Sym]]),linear(V1),shlin2([([V1,V2,Sym],[V1]),([V1,Sym],[V1]),([V2,Sym],[V1]),([Sym],[V1])]))),
...
:- true pred retrieve_sym(V,_A,X)
   : ( mshare([[V],[V,_A],[V,_A,X],[_A],[_A,X],[X]]),
       linear(V), shlin2([([V],[V]),([V,_A],[V]),([V,_A,X],[V]),([_A],[V]),([_A,X],[V]),([X],[V])]) )
...
:- true pred retrieve_sym(V,_A,X)
   : ( mshare([[V],[V,_A],[V,_A,X],[_A],[_A,X],[X]]),
       linear(V), shlin2([([V],[V]),([V,_A],[V]),([V,_A,X],[V]),([_A],[V]),([_A,X],[V]),([X],[V,X])]) )
   => ( mshare([[V,_A],[V,_A,X],[_A],[_A,X]]),
        shlin2([([V,_A],[]),([V,_A,X],[]),([_A],[]),([_A,X],[])]) ).

:- true pred retrieve_sym(V,_A,X)
   : ( mshare([[V,_A],[V,_A,X],[_A],[_A,X]]),
       linear(V), shlin2([([V,_A],[V]),([V,_A,X],[V]),([_A],[V]),([_A,X],[V])]) )
   => ( mshare([[V,_A],[V,_A,X],[_A],[_A,X]]),
        shlin2([([V,_A],[]),([V,_A,X],[]),([_A],[]),([_A,X],[])]) ).
