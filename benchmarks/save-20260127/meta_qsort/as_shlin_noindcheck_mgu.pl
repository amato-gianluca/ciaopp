...
interpret(G,_1) :-
    true((mshare([[G],[_1]]);mshare([[G],[_1]]),linear(_1);mshare([[_1]]),ground([G]);mshare([[_1]]),ground([G]),linear(_1))),
    var(G),
    !,
    true((fails(_);mshare([[G],[_1]]),linear(G);mshare([[G],[_1]]),linear(G),linear(_1))),
    fail,
    true(fails(_)).
interpret((A,B),Rest) :-
    !,
    true((mshare([[Rest],[A],[A,B],[B],[Rest0]]),linear(Rest),linear(Rest0);mshare([[Rest],[A],[A,B],[B],[Rest0]]),linear(Rest0);mshare([[Rest],[Rest0]]),ground([A,B]),linear(Rest),linear(Rest0);mshare([[Rest],[Rest0]]),ground([A,B]),linear(Rest0))),
    interpret(A,Rest0),
...
interpret((A;B),Rest) :-
    !,
    true((mshare([[Rest]]),ground([A,B]);mshare([[Rest]]),ground([A,B]),linear(Rest);mshare([[Rest],[A],[A,B],[B]]);mshare([[Rest],[A],[A,B],[B]]),linear(Rest))),
...
interpret(\+A,Rest) :-
    !,
    true((mshare([[Rest]]),ground([A]);mshare([[Rest]]),ground([A]),linear(Rest);mshare([[Rest],[A]]);mshare([[Rest],[A]]),linear(Rest))),
...
interpret(G,_1) :-
    ...
    number(G),
    !,
    true((mshare([[_1]]),ground([G]);mshare([[_1]]),ground([G]),linear(_1))),
    fail,
    true(fails(_)).
interpret(G,_1) :-
    true((mshare([[G],[_1]]);mshare([[G],[_1]]),linear(_1);mshare([[_1]]),ground([G]);mshare([[_1]]),ground([G]),linear(_1))),
...
interpret(G,_1) :-
    true((mshare([[G],[_1],[Body]]),linear(_1),linear(Body);mshare([[G],[_1],[Body]]),linear(Body);mshare([[_1],[Body]]),ground([G]),linear(_1),linear(Body);mshare([[_1],[Body]]),ground([G]),linear(Body))),
    define(G,Body),
...
:- true pred 'interpret/2/2/$disj/1'(Rest,B,Rest0)
   : mshare([[Rest],[B],[Rest0]])
   => mshare([[Rest],[Rest,B],[Rest,B,Rest0],[Rest,Rest0],[B],[Rest0]]).
...
'interpret/2/2/$disj/1'(Rest,B,Rest0) :-
    true((mshare([[Rest],[B],[B,Rest0],[Rest0]]);mshare([[Rest],[B],[Rest0]]);mshare([[Rest],[Rest0]]),ground([B]))),
    interpret(B,Rest),
    true((mshare([[Rest],[Rest,B],[Rest,B,Rest0],[B],[B,Rest0],[Rest0]]);mshare([[Rest],[Rest,B],[B],[Rest0]]);mshare([[Rest],[Rest0]]),ground([B]))).
...
interpret_disjunction((A->B),_1,Rest) :-
    true((mshare([[_1],[_1,A],[_1,A,B],[_1,B],[Rest],[A],[A,B],[B],[Rest0]]),linear(Rest),linear(Rest0);mshare([[_1],[_1,A],[_1,A,B],[_1,B],[Rest],[A],[A,B],[B],[Rest0]]),linear(Rest0);mshare([[Rest],[A],[A,B],[B],[Rest0]]),ground([_1]),linear(Rest),linear(Rest0);mshare([[Rest],[A],[A,B],[B],[Rest0]]),ground([_1]),linear(Rest0);mshare([[Rest],[A],[Rest0]]),ground([_1,B]),linear(Rest),linear(Rest0);mshare([[Rest],[A],[Rest0]]),ground([_1,B]),linear(Rest0);mshare([[Rest],[Rest0]]),ground([_1,A,B]),linear(Rest),linear(Rest0);mshare([[Rest],[Rest0]]),ground([_1,A,B]),linear(Rest0))),
    interpret(A,Rest0),
    !,
    ...
    true((mshare([[_1],[_1,Rest,A,B],[_1,Rest,A,B,Rest0],[_1,Rest,A,Rest0],[_1,Rest,B],[_1,Rest,B,Rest0],[_1,A],[_1,A,B],[_1,A,B,Rest0],[_1,A,Rest0],[_1,B],[_1,B,Rest0],[Rest],[Rest,A,B],[Rest,A,B,Rest0],[Rest,A,Rest0],[Rest,B],[Rest,B,Rest0],[Rest,Rest0],[A],[A,B],[A,B,Rest0],[A,Rest0],[B],[B,Rest0],[Rest0]]);mshare([[_1],[_1,Rest,A,B],[_1,Rest,A,B,Rest0],[_1,Rest,A,Rest0],[_1,Rest,B],[_1,Rest,B,Rest0],[_1,A],[Rest,A,B],[Rest,A,B,Rest0],[Rest,A,Rest0],[Rest,B],[Rest,B,Rest0],[Rest,Rest0],[A]]);mshare([[Rest],[Rest,A,B],[Rest,A,B,Rest0],[Rest,A,Rest0],[Rest,B],[Rest,B,Rest0],[Rest,Rest0],[A],[A,B],[A,B,Rest0],[A,Rest0],[B],[B,Rest0],[Rest0]]),ground([_1]);mshare([[Rest],[Rest,A,Rest0],[Rest,Rest0],[A],[A,Rest0],[Rest0]]),ground([_1,B]);mshare([[Rest],[Rest,Rest0],[Rest0]]),ground([_1,A,B]);mshare([[Rest,A,B],[Rest,A,B,Rest0],[Rest,A,Rest0],[Rest,B],[Rest,B,Rest0],[Rest,Rest0],[A]]),ground([_1]))).
interpret_disjunction((_1->_2),C,Rest) :-
    !,
    true((mshare([[C],[C,_1],[C,_1,_2],[C,_2],[Rest],[_1],[_1,_2],[_2]]);mshare([[C],[C,_1],[C,_1,_2],[C,_2],[Rest],[_1],[_1,_2],[_2]]),linear(Rest);mshare([[Rest]]),ground([C,_1,_2]);mshare([[Rest]]),ground([C,_1,_2]),linear(Rest);mshare([[Rest],[_1]]),ground([C,_2]);mshare([[Rest],[_1]]),ground([C,_2]),linear(Rest);mshare([[Rest],[_1],[_1,_2],[_2]]),ground([C]);mshare([[Rest],[_1],[_1,_2],[_2]]),ground([C]),linear(Rest))),
    interpret(C,Rest),
...
interpret_disjunction(A,_1,Rest) :-
    true((mshare([[A],[A,_1],[_1],[Rest]]);mshare([[A],[A,_1],[_1],[Rest]]),linear(Rest);mshare([[A],[Rest]]),ground([_1]);mshare([[A],[Rest]]),ground([_1]),linear(Rest);mshare([[Rest]]),ground([A,_1]);mshare([[Rest]]),ground([A,_1]),linear(Rest))),
    interpret(A,Rest),
...
interpret_disjunction(_1,B,Rest) :-
    true((mshare([[_1],[_1,B],[B],[Rest]]);mshare([[_1],[_1,B],[B],[Rest]]),linear(Rest);mshare([[_1],[Rest]]),ground([B]);mshare([[_1],[Rest]]),ground([B]),linear(Rest);mshare([[Rest]]),ground([_1,B]);mshare([[Rest]]),ground([_1,B]),linear(Rest))),
    interpret(B,Rest),
