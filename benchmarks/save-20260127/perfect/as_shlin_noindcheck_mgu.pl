...
power(_1,0,1) :-
    ...
    true(ground([_1])).
power(N,K,R) :-
    true((mshare([[R],[K1],[R1]]),ground([N,K]),linear(R),linear(K1),linear(R1);mshare([[R],[K1],[R1]]),ground([N,K]),linear(K1),linear(R1))),
    K1 is K-1,
    true((mshare([[R],[R1]]),ground([N,K,K1]),linear(R),linear(R1);mshare([[R],[R1]]),ground([N,K,K1]),linear(R1))),
    power(N,K1,R1),
    true((
        mshare([[R]]),
        ground([N,K,K1,R1])
