...
:- true pred tautology(Wff,Tlist,Flist)
   ...
   => ( mshare([[Wff],[Wff,_A],[_A]]),
        ground([Tlist,_B]), linear(_A), shlin2([([Wff],[]),([Wff,_A],[_A]),([_A],[_A])]) ).
...
:- true pred tautology(Wff,Tlist,Flist)
   ...
   => ( mshare([[Wff],[Wff,_A],[_A]]),
        ground([Flist,_B]), linear(_A), shlin2([([Wff],[]),([Wff,_A],[_A]),([_A],[_A])]) ).

:- true pred tautology(Wff,Tlist,Flist)
   : ( (Tlist=[_A|_B]),
       mshare([[Wff],[Flist],[_A]]),
       ground([_B]), linear(Wff), linear(Flist), linear(_A), shlin2([([Wff],[Wff]),([Flist],[Flist]),([_A],[_A])]) )
   => ( mshare([[Wff],[Wff,Flist],[Wff,_A],[Flist],[_A]]),
        ground([_B]), linear(Flist), linear(_A), shlin2([([Wff],[]),([Wff,Flist],[Flist]),([Wff,_A],[_A]),([Flist],[Flist]),([_A],[_A])]) ).

:- true pred tautology(Wff,Tlist,Flist)
   : ( (Flist=[_A|_B]),
       mshare([[Wff],[Tlist],[_A]]),
       ground([_B]), linear(Wff), linear(Tlist), linear(_A), shlin2([([Wff],[Wff]),([Tlist],[Tlist]),([_A],[_A])]) )
   => ( mshare([[Wff],[Wff,Tlist],[Wff,_A],[Tlist],[_A]]),
        ground([_B]), linear(Tlist), linear(_A), shlin2([([Wff],[]),([Wff,Tlist],[Tlist]),([Wff,_A],[_A]),([Tlist],[Tlist]),([_A],[_A])]) ).
