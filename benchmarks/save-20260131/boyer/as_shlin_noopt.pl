...
'tautology/3/1/$disj/1'(Wff,Tlist,Flist) :-
    ...
    true(fails(_)).
'tautology/3/1/$disj/1'(Wff,Tlist,Flist) :-
    true((mshare([[Wff],[Wff,Tlist],[Wff,Tlist,Flist],[Wff,Flist],[Tlist],[Tlist,Flist],[Flist],[If],[Then],[Else]]),linear(If),linear(Then),linear(Else);mshare([[Wff],[Wff,Tlist],[Tlist],[If],[Then],[Else]]),ground([Flist]),linear(If),linear(Then),linear(Else);mshare([[Wff],[Wff,Flist],[Flist],[If],[Then],[Else]]),ground([Tlist]),linear(If),linear(Then),linear(Else);mshare([[Wff],[If],[Then],[Else]]),ground([Tlist,Flist]),linear(If),linear(Then),linear(Else))),
    Wff=if(If,Then,Else),
    !,
...
rewrite(Atom,Atom) :-
    ...
    true(ground([Atom])).
rewrite(Old,New) :-
    true((mshare([[Old],[New],[F],[N],[Mid]]),linear(New),linear(F),linear(N),linear(Mid);mshare([[Old],[New],[F],[N],[Mid]]),linear(F),linear(N),linear(Mid);mshare([[Old],[F],[N],[Mid]]),ground([New]),linear(F),linear(N),linear(Mid);mshare([[New],[F],[N],[Mid]]),ground([Old]),linear(New),linear(F),linear(N),linear(Mid);mshare([[New],[F],[N],[Mid]]),ground([Old]),linear(F),linear(N),linear(Mid);mshare([[F],[N],[Mid]]),ground([Old,New]),linear(F),linear(N),linear(Mid))),
    functor(Old,F,N),
    true((mshare([[Old],[New],[Mid]]),ground([F,N]),linear(New),linear(Mid);mshare([[Old],[New],[Mid]]),ground([F,N]),linear(Mid);mshare([[Old],[Mid]]),ground([New,F,N]),linear(Mid);mshare([[New],[Mid]]),ground([Old,F,N]),linear(New),linear(Mid);mshare([[New],[Mid]]),ground([Old,F,N]),linear(Mid);mshare([[Mid]]),ground([Old,New,F,N]),linear(Mid))),
    functor(Mid,F,N),
    true((mshare([[Old],[New],[Mid]]),ground([F,N]),linear(New),linear(Mid);mshare([[Old],[New],[Mid]]),ground([F,N]),linear(Mid);mshare([[Old],[Mid]]),ground([New,F,N]),linear(Mid);mshare([[New],[Mid]]),ground([Old,F,N]),linear(New),linear(Mid);mshare([[New],[Mid]]),ground([Old,F,N]),linear(Mid);mshare([[Mid]]),ground([Old,New,F,N]),linear(Mid))),
    rewrite_args(N,Old,Mid),
    true((mshare([[Old],[New],[Mid]]),ground([F,N]);mshare([[Old],[New],[Mid]]),ground([F,N]),linear(New);mshare([[Old],[Mid]]),ground([New,F,N]);mshare([[New],[Mid]]),ground([Old,F,N]);mshare([[New],[Mid]]),ground([Old,F,N]),linear(New);mshare([[Mid]]),ground([Old,New,F,N]))),
...
:- true pred 'rewrite/2/2/$disj/1'(New,Mid)
   : ( mshare([[Mid]]),
       ground([New]), linear(Mid) )
   => ( mshare([[Mid]]),
        ground([New]) ).

'rewrite/2/2/$disj/1'(New,Mid) :-
    true((mshare([[New],[Mid],[Next]]),linear(New),linear(Mid),linear(Next);mshare([[New],[Mid],[Next]]),linear(New),linear(Next);mshare([[New],[Mid],[Next]]),linear(Mid),linear(Next);mshare([[New],[Mid],[Next]]),linear(Next);mshare([[Mid],[Next]]),ground([New]),linear(Mid),linear(Next);mshare([[Mid],[Next]]),ground([New]),linear(Next))),
    equal(Mid,Next),
    true((mshare([[New],[Mid],[Mid,Next]]);mshare([[New],[Mid],[Mid,Next]]),linear(New);mshare([[Mid],[Mid,Next]]),ground([New]))),
    rewrite(Next,New),
    true((mshare([[New],[Mid],[Mid,Next]]);mshare([[Mid],[Mid,Next]]),ground([New]))).
'rewrite/2/2/$disj/1'(New,Mid) :-
    true((mshare([[New],[Mid]]);mshare([[New],[Mid]]),linear(New);mshare([[New],[Mid]]),linear(New),linear(Mid);mshare([[New],[Mid]]),linear(Mid);mshare([[Mid]]),ground([New]);mshare([[Mid]]),ground([New]),linear(Mid))),
    New=Mid,
    true((mshare([[New,Mid]]);mshare([[New,Mid]]),linear(New),linear(Mid);ground([New,Mid]))).
...
rewrite_args(0,_1,_2) :-
    !,
    true((mshare([[_1],[_2]]);mshare([[_1],[_2]]),linear(_2);mshare([[_2]]),ground([_1]);mshare([[_2]]),ground([_1]),linear(_2);ground([_1,_2]))).
rewrite_args(N,Old,Mid) :-
    true((mshare([[Old],[Mid],[OldArg],[MidArg],[N1]]),ground([N]),linear(Mid),linear(OldArg),linear(MidArg),linear(N1);mshare([[Old],[Mid],[OldArg],[MidArg],[N1]]),ground([N]),linear(OldArg),linear(MidArg),linear(N1);mshare([[Mid],[OldArg],[MidArg],[N1]]),ground([N,Old]),linear(Mid),linear(OldArg),linear(MidArg),linear(N1);mshare([[Mid],[OldArg],[MidArg],[N1]]),ground([N,Old]),linear(OldArg),linear(MidArg),linear(N1);mshare([[OldArg],[MidArg],[N1]]),ground([N,Old,Mid]),linear(OldArg),linear(MidArg),linear(N1))),
    arg(N,Old,OldArg),
    true((mshare([[Old,OldArg],[Mid],[MidArg],[N1]]),ground([N]),linear(Mid),linear(MidArg),linear(N1);mshare([[Old,OldArg],[Mid],[MidArg],[N1]]),ground([N]),linear(MidArg),linear(N1);mshare([[Mid],[MidArg],[N1]]),ground([N,Old,OldArg]),linear(Mid),linear(MidArg),linear(N1);mshare([[Mid],[MidArg],[N1]]),ground([N,Old,OldArg]),linear(MidArg),linear(N1);mshare([[MidArg],[N1]]),ground([N,Old,Mid,OldArg]),linear(MidArg),linear(N1))),
    arg(N,Mid,MidArg),
    true((mshare([[Old,OldArg],[Mid,MidArg],[N1]]),ground([N]),linear(Mid),linear(MidArg),linear(N1);mshare([[Old,OldArg],[Mid,MidArg],[N1]]),ground([N]),linear(N1);mshare([[Mid,MidArg],[N1]]),ground([N,Old,OldArg]),linear(Mid),linear(MidArg),linear(N1);mshare([[Mid,MidArg],[N1]]),ground([N,Old,OldArg]),linear(N1);mshare([[N1]]),ground([N,Old,Mid,OldArg,MidArg]),linear(N1))),
    rewrite(OldArg,MidArg),
    true((mshare([[Old,OldArg],[Mid,MidArg],[N1]]),ground([N]),linear(N1);mshare([[Mid,MidArg],[N1]]),ground([N,Old,OldArg]),linear(N1);mshare([[N1]]),ground([N,Old,Mid,OldArg,MidArg]),linear(N1))),
    N1 is N-1,
...
equal(boyer_difference(A,B),C) :-
    true((mshare([[C],[A],[A,B],[B]]),linear(C);mshare([[C],[A],[B]]),linear(C),linear(A),linear(B))),
    boyer_difference(A,B,C),
    true((mshare([[C,A],[C,A,B],[C,B],[A,B]]);mshare([[C,A],[C,B],[A,B]]),linear(A))).
...
equal(exp(A,B),C) :-
    true((mshare([[C],[A],[A,B],[B]]),linear(C);mshare([[C],[A],[B]]),linear(C),linear(A),linear(B))),
    exp(A,B,C),
    true((mshare([[C,A],[C,A,B],[C,B]]);mshare([[C,A],[C,B]]),linear(A),linear(B))).
...
equal(gcd(A,B),C) :-
    true((mshare([[C],[A],[A,B],[B]]),linear(C);mshare([[C],[A],[B]]),linear(C),linear(A),linear(B))),
    gcd(A,B,C),
    true((mshare([[C,A],[C,A,B],[C,B]]);mshare([[C,A],[C,A,B],[C,B]]),linear(C),linear(A),linear(B))).
...
equal(length(A),B) :-
    true((mshare([[B],[A]]),linear(B);mshare([[B],[A]]),linear(B),linear(A))),
    mylength(A,B),
    true((mshare([[B,A],[A]]);mshare([[B,A],[A]]),linear(B),linear(A))).
equal(lesseqp(X,Y),not(lessp(Y,X))).
equal(lessp(A,B),C) :-
    true((mshare([[C],[A],[A,B],[B]]),linear(C);mshare([[C],[A],[B]]),linear(C),linear(A),linear(B))),
    lessp(A,B,C),
    true((mshare([[C,A],[C,A,B],[C,B],[A],[A,B]]);mshare([[C,A],[C,A,B],[C,B],[A],[A,B]]),linear(A),linear(B))).
...
equal(my_nth(A,B),C) :-
    true((mshare([[C],[A],[A,B],[B]]),linear(C);mshare([[C],[A],[B]]),linear(C),linear(A),linear(B))),
    my_nth(A,B,C),
    true((mshare([[C,A],[C,A,B],[C,B],[B]]);mshare([[C,A],[C,B],[B]]),linear(B))).
equal(numberp(greatest_factor(X,Y)),not(and(or(zerop(Y),equal(Y,1)),not(numberp(X))))).
equal(or(P,Q),if(P,t,if(Q,t,f),f)).
equal(myplus(A,B),C) :-
    true((mshare([[C],[A],[A,B],[B]]),linear(C);mshare([[C],[A],[B]]),linear(C),linear(A),linear(B))),
    myplus(A,B,C),
    true((mshare([[C,A],[C,A,B],[C,B],[A,B]]);mshare([[C,A],[C,A,B],[C,B],[A,B]]),linear(A))).
equal(power_eval(A,B),C) :-
    true((mshare([[C],[A],[A,B],[B]]),linear(C);mshare([[C],[A],[B]]),linear(C),linear(A),linear(B))),
    power_eval(A,B,C),
    true((mshare([[C,A],[C,A,B],[A,B]]);mshare([[C,A],[C,A,B],[A,B]]),linear(B))).
...
equal(quotient(A,B),C) :-
    true((mshare([[C],[A],[A,B],[B]]),linear(C);mshare([[C],[A],[B]]),linear(C),linear(A),linear(B))),
    quotient(A,B,C),
    true((mshare([[C,A],[C,A,B]]);mshare([[C,A],[C,A,B]]),linear(C))).
equal(remainder(A,B),C) :-
    true((mshare([[C],[A],[A,B],[B]]),linear(C);mshare([[C],[A],[B]]),linear(C),linear(A),linear(B))),
    remainder(A,B,C),
    true((mshare([[A],[A,B]]),ground([C]);mshare([[A],[A,B]]),ground([C]),linear(A))).
equal(reverse_(X),reverse_loop(X,[])).
equal(reverse(append(A,B)),append(reverse(B),reverse(A))).
equal(reverse_loop(A,B),C) :-
    true((mshare([[C],[A],[A,B],[B]]),linear(C);mshare([[C],[A],[B]]),linear(C),linear(A),linear(B))),
    reverse_loop(A,B,C),
    true((mshare([[C,A],[C,A,B],[C,B]]);mshare([[C,A],[C,B]]),linear(C),linear(A))).
...
boyer_difference(myplus(X,Y),X,fix(Y)) :-
    !,
    true((mshare([[X],[X,Y],[Y]]);mshare([[X],[Y]]),linear(X),linear(Y))).
boyer_difference(myplus(Y,X),X,fix(Y)) :-
    !,
    true((mshare([[X],[X,Y],[Y]]);mshare([[X],[Y]]),linear(X),linear(Y))).
boyer_difference(myplus(X,Y),myplus(X,Z),boyer_difference(Y,Z)) :-
    !,
    true((mshare([[X],[X,Y],[X,Y,Z],[X,Z],[Y],[Y,Z],[Z]]);mshare([[X],[Y],[Z]]),linear(X),linear(Y),linear(Z))).
boyer_difference(myplus(B,myplus(A,C)),A,myplus(B,C)) :-
    !,
    true((mshare([[A],[A,B],[A,B,C],[A,C],[B],[B,C],[C]]);mshare([[A],[B],[C]]),linear(A),linear(B),linear(C))).
boyer_difference(add1(myplus(Y,Z)),Z,add1(Y)) :-
    !,
    true((mshare([[Z],[Z,Y],[Y]]);mshare([[Z],[Y]]),linear(Z),linear(Y))).
...
:- true pred eq(X,Z,_A)
   : ( mshare([[X],[Z],[_A]]),
       linear(X), linear(Z), linear(_A) )
   => mshare([[X],[X,Z],[X,Z,_A],[X,_A],[Z,_A]]).

eq(myplus(A,B),zero,and(zerop(A),zerop(B))) :-
    !,
    true((mshare([[A],[A,B],[B]]);mshare([[A],[B]]),linear(A),linear(B))).
...
eq(greatest_factor(X,_1),1,equal(X,1)) :-
    !,
    true((mshare([[X],[X,_1],[_1]]);mshare([[X],[_1]]),linear(X),linear(_1))).
eq(Z,times(W,Z),and(numberp(Z),or(equal(Z,zero),equal(W,1)))) :-
    !,
    true((mshare([[Z],[Z,W],[W]]);mshare([[Z],[W]]),linear(Z),linear(W))).
...
:- true pred exp(I,_A,_B)
   : ( mshare([[I],[_A],[_B]]),
       linear(I), linear(_A), linear(_B) )
   => ( mshare([[I,_B],[_A,_B]]),
        linear(I), linear(_A) ).

exp(I,myplus(J,K),times(exp(I,J),exp(I,K))) :-
    !,
    true((mshare([[I],[I,J],[I,J,K],[I,K],[J],[J,K],[K]]);mshare([[I],[J],[K]]),linear(I),linear(J),linear(K))).
...
:- true pred lessp(_A,Y,_B)
   : ( mshare([[_A],[Y],[_B]]),
       linear(_A), linear(Y), linear(_B) )
   => ( mshare([[_A],[_A,Y],[_A,Y,_B],[_A,_B],[Y,_B]]),
        linear(_A), linear(Y) ).

lessp(remainder(_1,Y),Y,not(zerop(Y))) :-
    !,
    true((mshare([[Y],[Y,_1],[_1]]);mshare([[Y],[_1]]),linear(Y),linear(_1))).
lessp(quotient(I,J),I,and(not(zerop(I)),or(zerop(J),not(equal(J,1))))) :-
    !,
    true((mshare([[I],[I,J],[J]]);mshare([[I],[J]]),linear(I),linear(J))).
...
lessp(times(X,Z),times(Y,Z),and(not(zerop(Z)),lessp(X,Y))) :-
    !,
    true((mshare([[X],[X,Z],[X,Z,Y],[X,Y],[Z],[Z,Y],[Y]]);mshare([[X],[Z],[Y]]),linear(X),linear(Z),linear(Y))).
lessp(Y,myplus(X,Y),not(zerop(X))) :-
    !,
    true((mshare([[Y],[Y,X],[X]]);mshare([[Y],[X]]),linear(Y),linear(X))).
...
:- true pred meaning(_A,A,_B)
   : ( mshare([[_A],[A],[_B]]),
       linear(_A), linear(A), linear(_B) )
   => ( mshare([[_A,_B],[A,_B]]),
        linear(_A), linear(A) ).

meaning(plus_tree(append(X,Y)),A,myplus(meaning(plus_tree(X),A),meaning(plus_tree(Y),A))) :-
    !,
    true((mshare([[A],[A,X],[A,X,Y],[A,Y],[X],[X,Y],[Y]]);mshare([[A],[X],[Y]]),linear(A),linear(X),linear(Y))).
meaning(plus_tree(plus_fringe(X)),A,fix(meaning(X,A))) :-
    !,
    true((mshare([[A],[A,X],[X]]);mshare([[A],[X]]),linear(A),linear(X))).
...
:- true pred myboyer_member(X,_A,_B)
   : ( mshare([[X],[_A],[_B]]),
       linear(X), linear(_A), linear(_B) )
   => ( mshare([[X,_B],[_A,_B]]),
        linear(X), linear(_A) ).

myboyer_member(X,append(A,B),or(boyer_member(X,A),boyer_member(X,B))) :-
    !,
    true((mshare([[X],[X,A],[X,A,B],[X,B],[A],[A,B],[B]]);mshare([[X],[A],[B]]),linear(X),linear(A),linear(B))).
...
myplus(myplus(X,Y),Z,myplus(X,myplus(Y,Z))) :-
    !,
    true((mshare([[Z],[Z,X],[Z,X,Y],[Z,Y],[X],[X,Y],[Y]]);mshare([[Z],[X],[Y]]),linear(Z),linear(X),linear(Y))).
...
:- true pred power_eval(_A,Base,_B)
   : ( mshare([[_A],[Base],[_B]]),
       linear(_A), linear(Base), linear(_B) )
   => ( mshare([[_A,Base],[_A,Base,_B],[_A,_B]]),
        linear(Base) ).

power_eval(big_plus1(L,I,Base),Base,myplus(power_eval(L,Base),I)) :-
    !,
    true((mshare([[Base],[Base,L],[Base,L,I],[Base,I],[L],[L,I],[I]]);mshare([[Base],[L],[I]]),linear(Base),linear(L),linear(I))).
power_eval(power_rep(I,Base),Base,fix(I)) :-
    !,
    true((mshare([[Base],[Base,I],[I]]);mshare([[Base],[I]]),linear(Base),linear(I))).
power_eval(big_plus(X,Y,I,Base),Base,myplus(I,myplus(power_eval(X,Base),power_eval(Y,Base)))) :-
    !,
    true((mshare([[Base],[Base,X],[Base,X,Y],[Base,X,Y,I],[Base,X,I],[Base,Y],[Base,Y,I],[Base,I],[X],[X,Y],[X,Y,I],[X,I],[Y],[Y,I],[I]]);mshare([[Base],[X],[Y],[I]]),linear(Base),linear(X),linear(Y),linear(I))).
...
:- true pred remainder(_1,X,_A)
   : ( mshare([[_1],[X],[_A]]),
       linear(_1), linear(X), linear(_A) )
   => ( mshare([[_1],[_1,X]]),
        ground([_A]), linear(_1) ).

remainder(_1,1,zero) :-
    !,
    true((mshare([[_1]]);mshare([[_1]]),linear(_1))).
remainder(X,X,zero) :-
    !,
    true((mshare([[X]]);mshare([[X]]),linear(X))).
remainder(times(_1,Z),Z,zero) :-
    !,
    true((mshare([[Z],[Z,_1],[_1]]);mshare([[Z],[_1]]),linear(Z),linear(_1))).
...
times(X,boyer_difference(C,W),boyer_difference(times(C,X),times(W,X))) :-
    !,
    true((mshare([[X],[X,C],[X,C,W],[X,W],[C],[C,W],[W]]);mshare([[X],[C],[W]]),linear(X),linear(C),linear(W))).
