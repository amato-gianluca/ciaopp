...
treat_disj([disj((A;B),N,X,C)|Disjs],DummyClauses,Link) :-
    ...
    true((
        ...
        linear(Name),
        linear(Rest),
        shlin2([([DummyClauses],[DummyClauses]),([Disjs],[]),([Disjs,N],[]),([Disjs,N,X],[]),([Disjs,N,X,C],[]),([Disjs,N,X,C,A,B,Vars],[]),([Disjs,N,X,C,A,Vars],[]),([Disjs,N,X,C,B,Vars],[]),([Disjs,N,X,A,B,Vars],[]),([Disjs,N,X,A,Vars],[]),([Disjs,N,X,B,Vars],[]),([Disjs,N,C],[]),([Disjs,N,C,A,B,Vars],[]),([Disjs,N,C,A,Vars],[]),([Disjs,N,C,B,Vars],[]),([Disjs,N,A,B,Vars],[]),([Disjs,N,A,Vars],[]),([Disjs,N,B,Vars],[]),([Disjs,X],[]),([Disjs,X,C],[]),([Disjs,X,C,A,B,Vars],[]),([Disjs,X,C,A,Vars],[]),([Disjs,X,C,B,Vars],[]),([Disjs,X,A,B,Vars],[]),([Disjs,X,A,Vars],[]),([Disjs,X,B,Vars],[]),([Disjs,C],[]),([Disjs,C,A,B,Vars],[]),([Disjs,C,A,Vars],[]),([Disjs,C,B,Vars],[]),([Disjs,A,B,Vars],[]),([Disjs,A,Vars],[]),([Disjs,B,Vars],[]),([N],[]),([N,X],[]),([N,X,C],[]),([N,X,C,A,B,Vars],[]),([N,X,C,A,Vars],[]),([N,X,C,B,Vars],[]),([N,X,A,B,Vars],[]),([N,X,A,Vars],[]),([N,X,B,Vars],[]),([N,C],[]),([N,C,A,B,Vars],[]),([N,C,A,Vars],[]),([N,C,B,Vars],[]),([N,A,B,Vars],[]),([N,A,Vars],[]),([N,B,Vars],[]),([X],[]),([X,C],[]),([X,C,A,B,Vars],[]),([X,C,A,Vars],[]),([X,C,B,Vars],[]),([X,A,B,Vars],[]),([X,A,Vars],[]),([X,B,Vars],[]),([C],[]),([C,A,B,Vars],[]),([C,A,Vars],[]),([C,B,Vars],[]),([A,B,Vars],[]),([A,Vars],[]),([B,Vars],[]),([CVars],[CVars]),([Args],[Args]),([Name],[Name]),([Rest],[Rest])])
    )),
    find_vars(C,CVars),
    true((
        ...
        linear(Name),
        linear(Rest),
        shlin2([([DummyClauses],[DummyClauses]),([Disjs],[]),([Disjs,N],[]),([Disjs,N,X],[]),([Disjs,N,X,C,A,B,Vars,CVars],[]),([Disjs,N,X,C,A,Vars,CVars],[]),([Disjs,N,X,C,B,Vars,CVars],[]),([Disjs,N,X,C,CVars],[]),([Disjs,N,X,A,B,Vars],[]),([Disjs,N,X,A,Vars],[]),([Disjs,N,X,B,Vars],[]),([Disjs,N,C,A,B,Vars,CVars],[]),([Disjs,N,C,A,Vars,CVars],[]),([Disjs,N,C,B,Vars,CVars],[]),([Disjs,N,C,CVars],[]),([Disjs,N,A,B,Vars],[]),([Disjs,N,A,Vars],[]),([Disjs,N,B,Vars],[]),([Disjs,X],[]),([Disjs,X,C,A,B,Vars,CVars],[]),([Disjs,X,C,A,Vars,CVars],[]),([Disjs,X,C,B,Vars,CVars],[]),([Disjs,X,C,CVars],[]),([Disjs,X,A,B,Vars],[]),([Disjs,X,A,Vars],[]),([Disjs,X,B,Vars],[]),([Disjs,C,A,B,Vars,CVars],[]),([Disjs,C,A,Vars,CVars],[]),([Disjs,C,B,Vars,CVars],[]),([Disjs,C,CVars],[]),([Disjs,A,B,Vars],[]),([Disjs,A,Vars],[]),([Disjs,B,Vars],[]),([N],[]),([N,X],[]),([N,X,C,A,B,Vars,CVars],[]),([N,X,C,A,Vars,CVars],[]),([N,X,C,B,Vars,CVars],[]),([N,X,C,CVars],[]),([N,X,A,B,Vars],[]),([N,X,A,Vars],[]),([N,X,B,Vars],[]),([N,C,A,B,Vars,CVars],[]),([N,C,A,Vars,CVars],[]),([N,C,B,Vars,CVars],[]),([N,C,CVars],[]),([N,A,B,Vars],[]),([N,A,Vars],[]),([N,B,Vars],[]),([X],[]),([X,C,A,B,Vars,CVars],[]),([X,C,A,Vars,CVars],[]),([X,C,B,Vars,CVars],[]),([X,C,CVars],[]),([X,A,B,Vars],[]),([X,A,Vars],[]),([X,B,Vars],[]),([C,A,B,Vars,CVars],[]),([C,A,Vars,CVars],[]),([C,B,Vars,CVars],[]),([C,CVars],[]),([A,B,Vars],[]),([A,Vars],[]),([B,Vars],[]),([Args],[Args]),([Name],[Name]),([Rest],[Rest])])
    )),
    intersect_vars(Vars,CVars,Args),
    true((
        mshare([[DummyClauses],[Disjs],[Disjs,N],[Disjs,N,X],[Disjs,N,X,C,A,B,Vars,CVars],[Disjs,N,X,C,A,B,Vars,CVars,Args],[Disjs,N,X,C,A,Vars,CVars],[Disjs,N,X,C,A,Vars,CVars,Args],[Disjs,N,X,C,B,Vars,CVars],[Disjs,N,X,C,B,Vars,CVars,Args],[Disjs,N,X,C,CVars],[Disjs,N,X,A,B,Vars],[Disjs,N,X,A,Vars],[Disjs,N,X,B,Vars],[Disjs,N,C,A,B,Vars,CVars],[Disjs,N,C,A,B,Vars,CVars,Args],[Disjs,N,C,A,Vars,CVars],[Disjs,N,C,A,Vars,CVars,Args],[Disjs,N,C,B,Vars,CVars],[Disjs,N,C,B,Vars,CVars,Args],[Disjs,N,C,CVars],[Disjs,N,A,B,Vars],[Disjs,N,A,Vars],[Disjs,N,B,Vars],[Disjs,X],[Disjs,X,C,A,B,Vars,CVars],[Disjs,X,C,A,B,Vars,CVars,Args],[Disjs,X,C,A,Vars,CVars],[Disjs,X,C,A,Vars,CVars,Args],[Disjs,X,C,B,Vars,CVars],[Disjs,X,C,B,Vars,CVars,Args],[Disjs,X,C,CVars],[Disjs,X,A,B,Vars],[Disjs,X,A,Vars],[Disjs,X,B,Vars],[Disjs,C,A,B,Vars,CVars],[Disjs,C,A,B,Vars,CVars,Args],[Disjs,C,A,Vars,CVars],[Disjs,C,A,Vars,CVars,Args],[Disjs,C,B,Vars,CVars],[Disjs,C,B,Vars,CVars,Args],[Disjs,C,CVars],[Disjs,A,B,Vars],[Disjs,A,Vars],[Disjs,B,Vars],[N],[N,X],[N,X,C,A,B,Vars,CVars],[N,X,C,A,B,Vars,CVars,Args],[N,X,C,A,Vars,CVars],[N,X,C,A,Vars,CVars,Args],[N,X,C,B,Vars,CVars],[N,X,C,B,Vars,CVars,Args],[N,X,C,CVars],[N,X,A,B,Vars],[N,X,A,Vars],[N,X,B,Vars],[N,C,A,B,Vars,CVars],[N,C,A,B,Vars,CVars,Args],[N,C,A,Vars,CVars],[N,C,A,Vars,CVars,Args],[N,C,B,Vars,CVars],[N,C,B,Vars,CVars,Args],[N,C,CVars],[N,A,B,Vars],[N,A,Vars],[N,B,Vars],[X],[X,C,A,B,Vars,CVars],[X,C,A,B,Vars,CVars,Args],[X,C,A,Vars,CVars],[X,C,A,Vars,CVars,Args],[X,C,B,Vars,CVars],[X,C,B,Vars,CVars,Args],[X,C,CVars],[X,A,B,Vars],[X,A,Vars],[X,B,Vars],[C,A,B,Vars,CVars],[C,A,B,Vars,CVars,Args],[C,A,Vars,CVars],[C,A,Vars,CVars,Args],[C,B,Vars,CVars],[C,B,Vars,CVars,Args],[C,CVars],[A,B,Vars],[A,Vars],[B,Vars],[Name],[Rest]]),
        ground([Link]),
        linear(DummyClauses),
        linear(Name),
        linear(Rest),
        shlin2([([DummyClauses],[DummyClauses]),([Disjs],[]),([Disjs,N],[]),([Disjs,N,X],[]),([Disjs,N,X,C,A,B,Vars,CVars],[]),([Disjs,N,X,C,A,B,Vars,CVars,Args],[]),([Disjs,N,X,C,A,Vars,CVars],[]),([Disjs,N,X,C,A,Vars,CVars,Args],[]),([Disjs,N,X,C,B,Vars,CVars],[]),([Disjs,N,X,C,B,Vars,CVars,Args],[]),([Disjs,N,X,C,CVars],[]),([Disjs,N,X,A,B,Vars],[]),([Disjs,N,X,A,Vars],[]),([Disjs,N,X,B,Vars],[]),([Disjs,N,C,A,B,Vars,CVars],[]),([Disjs,N,C,A,B,Vars,CVars,Args],[]),([Disjs,N,C,A,Vars,CVars],[]),([Disjs,N,C,A,Vars,CVars,Args],[]),([Disjs,N,C,B,Vars,CVars],[]),([Disjs,N,C,B,Vars,CVars,Args],[]),([Disjs,N,C,CVars],[]),([Disjs,N,A,B,Vars],[]),([Disjs,N,A,Vars],[]),([Disjs,N,B,Vars],[]),([Disjs,X],[]),([Disjs,X,C,A,B,Vars,CVars],[]),([Disjs,X,C,A,B,Vars,CVars,Args],[]),([Disjs,X,C,A,Vars,CVars],[]),([Disjs,X,C,A,Vars,CVars,Args],[]),([Disjs,X,C,B,Vars,CVars],[]),([Disjs,X,C,B,Vars,CVars,Args],[]),([Disjs,X,C,CVars],[]),([Disjs,X,A,B,Vars],[]),([Disjs,X,A,Vars],[]),([Disjs,X,B,Vars],[]),([Disjs,C,A,B,Vars,CVars],[]),([Disjs,C,A,B,Vars,CVars,Args],[]),([Disjs,C,A,Vars,CVars],[]),([Disjs,C,A,Vars,CVars,Args],[]),([Disjs,C,B,Vars,CVars],[]),([Disjs,C,B,Vars,CVars,Args],[]),([Disjs,C,CVars],[]),([Disjs,A,B,Vars],[]),([Disjs,A,Vars],[]),([Disjs,B,Vars],[]),([N],[]),([N,X],[]),([N,X,C,A,B,Vars,CVars],[]),([N,X,C,A,B,Vars,CVars,Args],[]),([N,X,C,A,Vars,CVars],[]),([N,X,C,A,Vars,CVars,Args],[]),([N,X,C,B,Vars,CVars],[]),([N,X,C,B,Vars,CVars,Args],[]),([N,X,C,CVars],[]),([N,X,A,B,Vars],[]),([N,X,A,Vars],[]),([N,X,B,Vars],[]),([N,C,A,B,Vars,CVars],[]),([N,C,A,B,Vars,CVars,Args],[]),([N,C,A,Vars,CVars],[]),([N,C,A,Vars,CVars,Args],[]),([N,C,B,Vars,CVars],[]),([N,C,B,Vars,CVars,Args],[]),([N,C,CVars],[]),([N,A,B,Vars],[]),([N,A,Vars],[]),([N,B,Vars],[]),([X],[]),([X,C,A,B,Vars,CVars],[]),([X,C,A,B,Vars,CVars,Args],[]),([X,C,A,Vars,CVars],[]),([X,C,A,Vars,CVars,Args],[]),([X,C,B,Vars,CVars],[]),([X,C,B,Vars,CVars,Args],[]),([X,C,CVars],[]),([X,A,B,Vars],[]),([X,A,Vars],[]),([X,B,Vars],[]),([C,A,B,Vars,CVars],[]),([C,A,B,Vars,CVars,Args],[]),([C,A,Vars,CVars],[]),([C,A,Vars,CVars,Args],[]),([C,B,Vars,CVars],[]),([C,B,Vars,CVars,Args],[]),([C,CVars],[]),([A,B,Vars],[]),([A,Vars],[]),([B,Vars],[]),([Name],[Name]),([Rest],[Rest])])
    )),
    make_dummy_name(N,Name),
    true((
        mshare([[DummyClauses],[Disjs],[Disjs,X],[Disjs,X,C,A,B,Vars,CVars],[Disjs,X,C,A,B,Vars,CVars,Args],[Disjs,X,C,A,Vars,CVars],[Disjs,X,C,A,Vars,CVars,Args],[Disjs,X,C,B,Vars,CVars],[Disjs,X,C,B,Vars,CVars,Args],[Disjs,X,C,CVars],[Disjs,X,A,B,Vars],[Disjs,X,A,Vars],[Disjs,X,B,Vars],[Disjs,C,A,B,Vars,CVars],[Disjs,C,A,B,Vars,CVars,Args],[Disjs,C,A,Vars,CVars],[Disjs,C,A,Vars,CVars,Args],[Disjs,C,B,Vars,CVars],[Disjs,C,B,Vars,CVars,Args],[Disjs,C,CVars],[Disjs,A,B,Vars],[Disjs,A,Vars],[Disjs,B,Vars],[X],[X,C,A,B,Vars,CVars],[X,C,A,B,Vars,CVars,Args],[X,C,A,Vars,CVars],[X,C,A,Vars,CVars,Args],[X,C,B,Vars,CVars],[X,C,B,Vars,CVars,Args],[X,C,CVars],[X,A,B,Vars],[X,A,Vars],[X,B,Vars],[C,A,B,Vars,CVars],[C,A,B,Vars,CVars,Args],[C,A,Vars,CVars],[C,A,Vars,CVars,Args],[C,B,Vars,CVars],[C,B,Vars,CVars,Args],[C,CVars],[A,B,Vars],[A,Vars],[B,Vars],[Rest]]),
        ground([Link,N,Name]),
        linear(DummyClauses),
        linear(Rest),
        shlin2([([DummyClauses],[DummyClauses]),([Disjs],[]),([Disjs,X],[]),([Disjs,X,C,A,B,Vars,CVars],[]),([Disjs,X,C,A,B,Vars,CVars,Args],[]),([Disjs,X,C,A,Vars,CVars],[]),([Disjs,X,C,A,Vars,CVars,Args],[]),([Disjs,X,C,B,Vars,CVars],[]),([Disjs,X,C,B,Vars,CVars,Args],[]),([Disjs,X,C,CVars],[]),([Disjs,X,A,B,Vars],[]),([Disjs,X,A,Vars],[]),([Disjs,X,B,Vars],[]),([Disjs,C,A,B,Vars,CVars],[]),([Disjs,C,A,B,Vars,CVars,Args],[]),([Disjs,C,A,Vars,CVars],[]),([Disjs,C,A,Vars,CVars,Args],[]),([Disjs,C,B,Vars,CVars],[]),([Disjs,C,B,Vars,CVars,Args],[]),([Disjs,C,CVars],[]),([Disjs,A,B,Vars],[]),([Disjs,A,Vars],[]),([Disjs,B,Vars],[]),([X],[]),([X,C,A,B,Vars,CVars],[]),([X,C,A,B,Vars,CVars,Args],[]),([X,C,A,Vars,CVars],[]),([X,C,A,Vars,CVars,Args],[]),([X,C,B,Vars,CVars],[]),([X,C,B,Vars,CVars,Args],[]),([X,C,CVars],[]),([X,A,B,Vars],[]),([X,A,Vars],[]),([X,B,Vars],[]),([C,A,B,Vars,CVars],[]),([C,A,B,Vars,CVars,Args],[]),([C,A,Vars,CVars],[]),([C,A,Vars,CVars,Args],[]),([C,B,Vars,CVars],[]),([C,B,Vars,CVars,Args],[]),([C,CVars],[]),([A,B,Vars],[]),([A,Vars],[]),([B,Vars],[]),([Rest],[Rest])])
    )),
    X=..[Name|Args],
    true((
        mshare([[DummyClauses],[Disjs],[Disjs,X,C,A,B,Vars,CVars,Args],[Disjs,X,C,A,Vars,CVars,Args],[Disjs,X,C,B,Vars,CVars,Args],[Disjs,C,A,B,Vars,CVars],[Disjs,C,A,Vars,CVars],[Disjs,C,B,Vars,CVars],[Disjs,C,CVars],[Disjs,A,B,Vars],[Disjs,A,Vars],[Disjs,B,Vars],[X,C,A,B,Vars,CVars,Args],[X,C,A,Vars,CVars,Args],[X,C,B,Vars,CVars,Args],[C,A,B,Vars,CVars],[C,A,Vars,CVars],[C,B,Vars,CVars],[C,CVars],[A,B,Vars],[A,Vars],[B,Vars],[Rest]]),
        ground([Link,N,Name]),
        linear(DummyClauses),
        linear(Rest),
        shlin2([([DummyClauses],[DummyClauses]),([Disjs],[]),([Disjs,X,C,A,B,Vars,CVars,Args],[]),([Disjs,X,C,A,Vars,CVars,Args],[]),([Disjs,X,C,B,Vars,CVars,Args],[]),([Disjs,C,A,B,Vars,CVars],[]),([Disjs,C,A,Vars,CVars],[]),([Disjs,C,B,Vars,CVars],[]),([Disjs,C,CVars],[]),([Disjs,A,B,Vars],[]),([Disjs,A,Vars],[]),([Disjs,B,Vars],[]),([X,C,A,B,Vars,CVars,Args],[]),([X,C,A,Vars,CVars,Args],[]),([X,C,B,Vars,CVars,Args],[]),([C,A,B,Vars,CVars],[]),([C,A,Vars,CVars],[]),([C,B,Vars,CVars],[]),([C,CVars],[]),([A,B,Vars],[]),([A,Vars],[]),([B,Vars],[]),([Rest],[Rest])])
    )),
    make_dummy_clauses((A;B),X,DummyClauses,Rest),
    true((
        mshare([[DummyClauses],[DummyClauses,Disjs,X,C,A,B,Vars,CVars,Args],[DummyClauses,Disjs,X,C,A,Vars,CVars,Args],[DummyClauses,Disjs,X,C,B,Vars,CVars,Args],[DummyClauses,Disjs,C,A,B,Vars,CVars],[DummyClauses,Disjs,C,A,Vars,CVars],[DummyClauses,Disjs,C,B,Vars,CVars],[DummyClauses,Disjs,A,B,Vars],[DummyClauses,Disjs,A,Vars],[DummyClauses,Disjs,B,Vars],[DummyClauses,X,C,A,B,Vars,CVars,Args],[DummyClauses,X,C,A,Vars,CVars,Args],[DummyClauses,X,C,B,Vars,CVars,Args],[DummyClauses,C,A,B,Vars,CVars],[DummyClauses,C,A,Vars,CVars],[DummyClauses,C,B,Vars,CVars],[DummyClauses,A,B,Vars],[DummyClauses,A,Vars],[DummyClauses,B,Vars],[DummyClauses,Rest],[Disjs],[Disjs,X,C,A,B,Vars,CVars,Args],[Disjs,X,C,A,Vars,CVars,Args],[Disjs,X,C,B,Vars,CVars,Args],[Disjs,C,A,B,Vars,CVars],[Disjs,C,A,Vars,CVars],[Disjs,C,B,Vars,CVars],[Disjs,C,CVars],[Disjs,A,B,Vars],[Disjs,A,Vars],[Disjs,B,Vars],[X,C,A,B,Vars,CVars,Args],[X,C,A,Vars,CVars,Args],[X,C,B,Vars,CVars,Args],[C,A,B,Vars,CVars],[C,A,Vars,CVars],[C,B,Vars,CVars],[C,CVars],[A,B,Vars],[A,Vars],[B,Vars]]),
        ground([Link,N,Name]),
        linear(Rest),
        shlin2([([DummyClauses],[]),([DummyClauses,Disjs,X,C,A,B,Vars,CVars,Args],[]),([DummyClauses,Disjs,X,C,A,Vars,CVars,Args],[]),([DummyClauses,Disjs,X,C,B,Vars,CVars,Args],[]),([DummyClauses,Disjs,C,A,B,Vars,CVars],[]),([DummyClauses,Disjs,C,A,Vars,CVars],[]),([DummyClauses,Disjs,C,B,Vars,CVars],[]),([DummyClauses,Disjs,A,B,Vars],[]),([DummyClauses,Disjs,A,Vars],[]),([DummyClauses,Disjs,B,Vars],[]),([DummyClauses,X,C,A,B,Vars,CVars,Args],[]),([DummyClauses,X,C,A,Vars,CVars,Args],[]),([DummyClauses,X,C,B,Vars,CVars,Args],[]),([DummyClauses,C,A,B,Vars,CVars],[]),([DummyClauses,C,A,Vars,CVars],[]),([DummyClauses,C,B,Vars,CVars],[]),([DummyClauses,A,B,Vars],[]),([DummyClauses,A,Vars],[]),([DummyClauses,B,Vars],[]),([DummyClauses,Rest],[DummyClauses,Rest]),([Disjs],[]),([Disjs,X,C,A,B,Vars,CVars,Args],[]),([Disjs,X,C,A,Vars,CVars,Args],[]),([Disjs,X,C,B,Vars,CVars,Args],[]),([Disjs,C,A,B,Vars,CVars],[]),([Disjs,C,A,Vars,CVars],[]),([Disjs,C,B,Vars,CVars],[]),([Disjs,C,CVars],[]),([Disjs,A,B,Vars],[]),([Disjs,A,Vars],[]),([Disjs,B,Vars],[]),([X,C,A,B,Vars,CVars,Args],[]),([X,C,A,Vars,CVars,Args],[]),([X,C,B,Vars,CVars,Args],[]),([C,A,B,Vars,CVars],[]),([C,A,Vars,CVars],[]),([C,B,Vars,CVars],[]),([C,CVars],[]),([A,B,Vars],[]),([A,Vars],[]),([B,Vars],[])])
    )),
    treat_disj(Disjs,Rest,Link),
    true((
        mshare([[DummyClauses],[DummyClauses,Disjs,X,C,A,B,Vars,CVars,Args],[DummyClauses,Disjs,X,C,A,B,Vars,CVars,Args,Rest],[DummyClauses,Disjs,X,C,A,Vars,CVars,Args],[DummyClauses,Disjs,X,C,A,Vars,CVars,Args,Rest],[DummyClauses,Disjs,X,C,B,Vars,CVars,Args],[DummyClauses,Disjs,X,C,B,Vars,CVars,Args,Rest],[DummyClauses,Disjs,C,A,B,Vars,CVars],[DummyClauses,Disjs,C,A,B,Vars,CVars,Rest],[DummyClauses,Disjs,C,A,Vars,CVars],[DummyClauses,Disjs,C,A,Vars,CVars,Rest],[DummyClauses,Disjs,C,B,Vars,CVars],[DummyClauses,Disjs,C,B,Vars,CVars,Rest],[DummyClauses,Disjs,C,CVars,Rest],[DummyClauses,Disjs,A,B,Vars],[DummyClauses,Disjs,A,B,Vars,Rest],[DummyClauses,Disjs,A,Vars],[DummyClauses,Disjs,A,Vars,Rest],[DummyClauses,Disjs,B,Vars],[DummyClauses,Disjs,B,Vars,Rest],[DummyClauses,Disjs,Rest],[DummyClauses,X,C,A,B,Vars,CVars,Args],[DummyClauses,X,C,A,Vars,CVars,Args],[DummyClauses,X,C,B,Vars,CVars,Args],[DummyClauses,C,A,B,Vars,CVars],[DummyClauses,C,A,Vars,CVars],[DummyClauses,C,B,Vars,CVars],[DummyClauses,A,B,Vars],[DummyClauses,A,Vars],[DummyClauses,B,Vars],[DummyClauses,Rest],[Disjs],[Disjs,X,C,A,B,Vars,CVars,Args],[Disjs,X,C,A,Vars,CVars,Args],[Disjs,X,C,B,Vars,CVars,Args],[Disjs,C,A,B,Vars,CVars],[Disjs,C,A,Vars,CVars],[Disjs,C,B,Vars,CVars],[Disjs,C,CVars],[Disjs,A,B,Vars],[Disjs,A,Vars],[Disjs,B,Vars],[X,C,A,B,Vars,CVars,Args],[X,C,A,Vars,CVars,Args],[X,C,B,Vars,CVars,Args],[C,A,B,Vars,CVars],[C,A,Vars,CVars],[C,B,Vars,CVars],[C,CVars],[A,B,Vars],[A,Vars],[B,Vars]]),
        ground([Link,N,Name]),
        shlin2([([DummyClauses],[]),([DummyClauses,Disjs,X,C,A,B,Vars,CVars,Args],[]),([DummyClauses,Disjs,X,C,A,B,Vars,CVars,Args,Rest],[]),([DummyClauses,Disjs,X,C,A,Vars,CVars,Args],[]),([DummyClauses,Disjs,X,C,A,Vars,CVars,Args,Rest],[]),([DummyClauses,Disjs,X,C,B,Vars,CVars,Args],[]),([DummyClauses,Disjs,X,C,B,Vars,CVars,Args,Rest],[]),([DummyClauses,Disjs,C,A,B,Vars,CVars],[]),([DummyClauses,Disjs,C,A,B,Vars,CVars,Rest],[]),([DummyClauses,Disjs,C,A,Vars,CVars],[]),([DummyClauses,Disjs,C,A,Vars,CVars,Rest],[]),([DummyClauses,Disjs,C,B,Vars,CVars],[]),([DummyClauses,Disjs,C,B,Vars,CVars,Rest],[]),([DummyClauses,Disjs,C,CVars,Rest],[]),([DummyClauses,Disjs,A,B,Vars],[]),([DummyClauses,Disjs,A,B,Vars,Rest],[]),([DummyClauses,Disjs,A,Vars],[]),([DummyClauses,Disjs,A,Vars,Rest],[]),([DummyClauses,Disjs,B,Vars],[]),([DummyClauses,Disjs,B,Vars,Rest],[]),([DummyClauses,Disjs,Rest],[]),([DummyClauses,X,C,A,B,Vars,CVars,Args],[]),([DummyClauses,X,C,A,Vars,CVars,Args],[]),([DummyClauses,X,C,B,Vars,CVars,Args],[]),([DummyClauses,C,A,B,Vars,CVars],[]),([DummyClauses,C,A,Vars,CVars],[]),([DummyClauses,C,B,Vars,CVars],[]),([DummyClauses,A,B,Vars],[]),([DummyClauses,A,Vars],[]),([DummyClauses,B,Vars],[]),([DummyClauses,Rest],[]),([Disjs],[]),([Disjs,X,C,A,B,Vars,CVars,Args],[]),([Disjs,X,C,A,Vars,CVars,Args],[]),([Disjs,X,C,B,Vars,CVars,Args],[]),([Disjs,C,A,B,Vars,CVars],[]),([Disjs,C,A,Vars,CVars],[]),([Disjs,C,B,Vars,CVars],[]),([Disjs,C,CVars],[]),([Disjs,A,B,Vars],[]),([Disjs,A,Vars],[]),([Disjs,B,Vars],[]),([X,C,A,B,Vars,CVars,Args],[]),([X,C,A,Vars,CVars,Args],[]),([X,C,B,Vars,CVars,Args],[]),([C,A,B,Vars,CVars],[]),([C,A,Vars,CVars],[]),([C,B,Vars,CVars],[]),([C,CVars],[]),([A,B,Vars],[]),([A,Vars],[]),([B,Vars],[])])
    )).
...
:- true pred find_vars(Var,Vars,Link)
   ...
   => ( mshare([[Var,Vars],[Vars,Link]]),
        linear(Link), shlin2([([Var,Vars],[]),([Vars,Link],[Vars,Link])]) ).
...
find_vars([T|Ts],Vars,NewLink) :-
    ...
    true((
        ...
        linear(NewLink),
        linear(Link),
        shlin2([([Vars,T],[]),([Vars,T,Ts],[]),([Vars,Link],[Vars,Link]),([NewLink],[NewLink]),([Ts],[])])
    )),
    find_vars(Ts,Link,NewLink),
    true((
        mshare([[Vars,NewLink,Link],[Vars,T],[Vars,T,Ts,Link],[Vars,Ts,Link]]),
        linear(NewLink),
        shlin2([([Vars,NewLink,Link],[Vars,NewLink,Link]),([Vars,T],[]),([Vars,T,Ts,Link],[]),([Vars,Ts,Link],[])])
    )).
find_vars(Term,Vars,Link) :-
    ...
    true((
        ...
        linear(Vars),
        linear(Link),
        shlin2([([Term,Args],[]),([Vars],[Vars]),([Link],[Link])])
    )),
    ...
    true((
        ...
        ground([_1]),
        linear(Link),
        shlin2([([Term,Vars,Args],[]),([Vars,Link],[Vars,Link])])
    )).
...
copy(Term1,Term2) :-
    ...
    true((
        ...
        shlin2([([Term1],[]),([Term1,Term2,Set,Sym],[]),([Term1,Term2,Sym],[]),([Term1,Set,Sym],[]),([Term1,Sym],[]),([Term2],[]),([Term2,Sym],[]),([Sym],[])])
    )).

:- true pred copy2(V1,V2,Sym)
   : ( mshare([[V1,V2,Sym],[V1,Sym],[V2,Sym],[Sym]]),
       shlin2([([V1,V2,Sym],[]),([V1,Sym],[]),([V2,Sym],[]),([Sym],[])]) )
   => ( mshare([[V1,V2,Sym],[V1,Sym],[V2,Sym],[Sym]]),
        shlin2([([V1,V2,Sym],[]),([V1,Sym],[]),([V2,Sym],[]),([Sym],[])]) ).

:- true pred copy2(V1,V2,Sym)
   : ( mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),
       shlin2([([V1],[]),([V1,V2,Sym],[]),([V1,Sym],[]),([V2],[]),([V2,Sym],[]),([Sym],[])]) )
   => ( mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),
        shlin2([([V1],[]),([V1,V2,Sym],[]),([V1,Sym],[]),([V2],[]),([V2,Sym],[]),([Sym],[])]) ).
...
copy2(V1,V2,Sym) :-
    true((mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),shlin2([([V1],[]),([V1,V2,Sym],[]),([V1,Sym],[]),([V2],[]),([V2,Sym],[]),([Sym],[])]);mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),shlin2([([V1],[]),([V1,V2,Sym],[]),([V1,Sym],[]),([V2],[V2]),([V2,Sym],[]),([Sym],[])]);mshare([[V1],[V1,Sym],[V2],[Sym]]),linear(V2),shlin2([([V1],[]),([V1,Sym],[]),([V2],[V2]),([Sym],[Sym])]);mshare([[V1,V2,Sym],[V1,Sym],[V2,Sym],[Sym]]),shlin2([([V1,V2,Sym],[]),([V1,Sym],[]),([V2,Sym],[]),([Sym],[])]))),
    var(V1),
    !,
    true((mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),linear(V1),shlin2([([V1],[V1]),([V1,V2,Sym],[V1]),([V1,Sym],[V1]),([V2],[]),([V2,Sym],[]),([Sym],[])]);mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),linear(V1),shlin2([([V1],[V1]),([V1,V2,Sym],[V1]),([V1,Sym],[V1]),([V2],[V2]),([V2,Sym],[]),([Sym],[])]);mshare([[V1],[V1,Sym],[V2],[Sym]]),linear(V1),linear(V2),shlin2([([V1],[V1]),([V1,Sym],[V1]),([V2],[V2]),([Sym],[Sym])]);mshare([[V1,V2,Sym],[V1,Sym],[V2,Sym],[Sym]]),linear(V1),shlin2([([V1,V2,Sym],[V1]),([V1,Sym],[V1]),([V2,Sym],[]),([Sym],[])]))),
...
copy2(X1,X2,Sym) :-
    true((mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym],[Name],[Arity]]),linear(Name),linear(Arity),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[]),([X2,Sym],[]),([Sym],[]),([Name],[Name]),([Arity],[Arity])]);mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym],[Name],[Arity]]),linear(Name),linear(Arity),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[X2]),([X2,Sym],[]),([Sym],[]),([Name],[Name]),([Arity],[Arity])]);mshare([[X1],[X1,Sym],[X2],[Sym],[Name],[Arity]]),linear(X2),linear(Name),linear(Arity),shlin2([([X1],[]),([X1,Sym],[]),([X2],[X2]),([Sym],[Sym]),([Name],[Name]),([Arity],[Arity])]);mshare([[X1,X2,Sym],[X1,Sym],[X2,Sym],[Sym],[Name],[Arity]]),linear(Name),linear(Arity),shlin2([([X1,X2,Sym],[]),([X1,Sym],[]),([X2,Sym],[]),([Sym],[]),([Name],[Name]),([Arity],[Arity])]))),
    nonvar(X1),
    !,
    true((mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym],[Name],[Arity]]),linear(Name),linear(Arity),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[]),([X2,Sym],[]),([Sym],[]),([Name],[Name]),([Arity],[Arity])]);mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym],[Name],[Arity]]),linear(Name),linear(Arity),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[X2]),([X2,Sym],[]),([Sym],[]),([Name],[Name]),([Arity],[Arity])]);mshare([[X1],[X1,Sym],[X2],[Sym],[Name],[Arity]]),linear(X2),linear(Name),linear(Arity),shlin2([([X1],[]),([X1,Sym],[]),([X2],[X2]),([Sym],[Sym]),([Name],[Name]),([Arity],[Arity])]);mshare([[X1,X2,Sym],[X1,Sym],[X2,Sym],[Sym],[Name],[Arity]]),linear(Name),linear(Arity),shlin2([([X1,X2,Sym],[]),([X1,Sym],[]),([X2,Sym],[]),([Sym],[]),([Name],[Name]),([Arity],[Arity])]))),
    functor(X1,Name,Arity),
    true((mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym]]),ground([Name,Arity]),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[]),([X2,Sym],[]),([Sym],[])]);mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym]]),ground([Name,Arity]),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[X2]),([X2,Sym],[]),([Sym],[])]);mshare([[X1],[X1,Sym],[X2],[Sym]]),ground([Name,Arity]),linear(X2),shlin2([([X1],[]),([X1,Sym],[]),([X2],[X2]),([Sym],[Sym])]);mshare([[X1,X2,Sym],[X1,Sym],[X2,Sym],[Sym]]),ground([Name,Arity]),shlin2([([X1,X2,Sym],[]),([X1,Sym],[]),([X2,Sym],[]),([Sym],[])]))),
    functor(X2,Name,Arity),
    true((mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym]]),ground([Name,Arity]),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[]),([X2,Sym],[]),([Sym],[])]);mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym]]),ground([Name,Arity]),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[X2]),([X2,Sym],[]),([Sym],[])]);mshare([[X1],[X1,Sym],[X2],[Sym]]),ground([Name,Arity]),linear(X2),shlin2([([X1],[]),([X1,Sym],[]),([X2],[X2]),([Sym],[Sym])]);mshare([[X1,X2,Sym],[X1,Sym],[X2,Sym],[Sym]]),ground([Name,Arity]),shlin2([([X1,X2,Sym],[]),([X1,Sym],[]),([X2,Sym],[]),([Sym],[])]))),
    copy2(X1,X2,Sym,1,Arity),
    true((mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym]]),ground([Name,Arity]),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[]),([X2,Sym],[]),([Sym],[])]);mshare([[X1,X2,Sym],[X1,Sym],[X2,Sym],[Sym]]),ground([Name,Arity]),shlin2([([X1,X2,Sym],[]),([X1,Sym],[]),([X2,Sym],[]),([Sym],[])]))).

:- true pred copy2(_X1,_X2,_Sym,N,Arity)
   : ( (N=1),
       mshare([[_X1,_X2,_Sym],[_X1,_Sym],[_X2,_Sym],[_Sym]]),
       ground([Arity]), shlin2([([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2,_Sym],[]),([_Sym],[])]) )
   => ( mshare([[_X1,_X2,_Sym],[_X1,_Sym],[_X2,_Sym],[_Sym]]),
        ground([Arity]), shlin2([([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2,_Sym],[]),([_Sym],[])]) ).
...
:- true pred copy2(_X1,_X2,_Sym,N,Arity)
   : ( (N=1),
       ...
       ground([Arity]), shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[]),([_X2,_Sym],[]),([_Sym],[])]) )
   => ( mshare([[_X1],[_X1,_X2,_Sym],[_X1,_Sym],[_X2],[_X2,_Sym],[_Sym]]),
        ground([Arity]), shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[]),([_X2,_Sym],[]),([_Sym],[])]) ).
...
:- true pred copy2(_X1,_X2,_Sym,N,Arity)
   : ( mshare([[_X1],[_X1,_X2,_Sym],[_X1,_Sym],[_X2],[_X2,_Sym],[_Sym]]),
       ground([N,Arity]), shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[]),([_X2,_Sym],[]),([_Sym],[])]) )
   => ( mshare([[_X1],[_X1,_X2,_Sym],[_X1,_Sym],[_X2],[_X2,_Sym],[_Sym]]),
        ground([N,Arity]), shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[]),([_X2,_Sym],[]),([_Sym],[])]) ).
...
:- true pred copy2(_X1,_X2,_Sym,N,Arity)
   : ( mshare([[_X1,_X2,_Sym],[_X1,_Sym],[_X2,_Sym],[_Sym]]),
       ground([N,Arity]), shlin2([([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2,_Sym],[]),([_Sym],[])]) )
   => ( mshare([[_X1,_X2,_Sym],[_X1,_Sym],[_X2,_Sym],[_Sym]]),
        ground([N,Arity]), shlin2([([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2,_Sym],[]),([_Sym],[])]) ).

copy2(_X1,_X2,_Sym,N,Arity) :-
    true((mshare([[_X1],[_X1,_X2,_Sym],[_X1,_Sym],[_X2],[_X2,_Sym],[_Sym]]),ground([N,Arity]),shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[]),([_X2,_Sym],[]),([_Sym],[])]);mshare([[_X1],[_X1,_X2,_Sym],[_X1,_Sym],[_X2],[_X2,_Sym],[_Sym]]),ground([N,Arity]),shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[_X2]),([_X2,_Sym],[]),([_Sym],[])]);mshare([[_X1],[_X1,_Sym],[_X2],[_Sym]]),ground([N,Arity]),linear(_X2),shlin2([([_X1],[]),([_X1,_Sym],[]),([_X2],[_X2]),([_Sym],[_Sym])]);mshare([[_X1,_X2,_Sym],[_X1,_Sym],[_X2,_Sym],[_Sym]]),ground([N,Arity]),shlin2([([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2,_Sym],[]),([_Sym],[])]))),
    N>Arity,
    !,
    true((mshare([[_X1],[_X1,_X2,_Sym],[_X1,_Sym],[_X2],[_X2,_Sym],[_Sym]]),ground([N,Arity]),shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[]),([_X2,_Sym],[]),([_Sym],[])]);mshare([[_X1],[_X1,_X2,_Sym],[_X1,_Sym],[_X2],[_X2,_Sym],[_Sym]]),ground([N,Arity]),shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[_X2]),([_X2,_Sym],[]),([_Sym],[])]);mshare([[_X1],[_X1,_Sym],[_X2],[_Sym]]),ground([N,Arity]),linear(_X2),shlin2([([_X1],[]),([_X1,_Sym],[]),([_X2],[_X2]),([_Sym],[_Sym])]);mshare([[_X1,_X2,_Sym],[_X1,_Sym],[_X2,_Sym],[_Sym]]),ground([N,Arity]),shlin2([([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2,_Sym],[]),([_Sym],[])]))).
copy2(X1,X2,Sym,N,Arity) :-
    true((mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym],[Arg1],[Arg2],[N1]]),ground([N,Arity]),linear(Arg1),linear(Arg2),linear(N1),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[]),([X2,Sym],[]),([Sym],[]),([Arg1],[Arg1]),([Arg2],[Arg2]),([N1],[N1])]);mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym],[Arg1],[Arg2],[N1]]),ground([N,Arity]),linear(Arg1),linear(Arg2),linear(N1),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[X2]),([X2,Sym],[]),([Sym],[]),([Arg1],[Arg1]),([Arg2],[Arg2]),([N1],[N1])]);mshare([[X1],[X1,Sym],[X2],[Sym],[Arg1],[Arg2],[N1]]),ground([N,Arity]),linear(X2),linear(Arg1),linear(Arg2),linear(N1),shlin2([([X1],[]),([X1,Sym],[]),([X2],[X2]),([Sym],[Sym]),([Arg1],[Arg1]),([Arg2],[Arg2]),([N1],[N1])]);mshare([[X1,X2,Sym],[X1,Sym],[X2,Sym],[Sym],[Arg1],[Arg2],[N1]]),ground([N,Arity]),linear(Arg1),linear(Arg2),linear(N1),shlin2([([X1,X2,Sym],[]),([X1,Sym],[]),([X2,Sym],[]),([Sym],[]),([Arg1],[Arg1]),([Arg2],[Arg2]),([N1],[N1])]))),
    N=<Arity,
    !,
    true((mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym],[Arg1],[Arg2],[N1]]),ground([N,Arity]),linear(Arg1),linear(Arg2),linear(N1),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[]),([X2,Sym],[]),([Sym],[]),([Arg1],[Arg1]),([Arg2],[Arg2]),([N1],[N1])]);mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym],[Arg1],[Arg2],[N1]]),ground([N,Arity]),linear(Arg1),linear(Arg2),linear(N1),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[X2]),([X2,Sym],[]),([Sym],[]),([Arg1],[Arg1]),([Arg2],[Arg2]),([N1],[N1])]);mshare([[X1],[X1,Sym],[X2],[Sym],[Arg1],[Arg2],[N1]]),ground([N,Arity]),linear(X2),linear(Arg1),linear(Arg2),linear(N1),shlin2([([X1],[]),([X1,Sym],[]),([X2],[X2]),([Sym],[Sym]),([Arg1],[Arg1]),([Arg2],[Arg2]),([N1],[N1])]);mshare([[X1,X2,Sym],[X1,Sym],[X2,Sym],[Sym],[Arg1],[Arg2],[N1]]),ground([N,Arity]),linear(Arg1),linear(Arg2),linear(N1),shlin2([([X1,X2,Sym],[]),([X1,Sym],[]),([X2,Sym],[]),([Sym],[]),([Arg1],[Arg1]),([Arg2],[Arg2]),([N1],[N1])]))),
    arg(N,X1,Arg1),
    true((mshare([[X1,X2,Sym,Arg1],[X1,Sym,Arg1],[X1,Arg1],[X2],[X2,Sym],[Sym],[Arg2],[N1]]),ground([N,Arity]),linear(Arg2),linear(N1),shlin2([([X1,X2,Sym,Arg1],[]),([X1,Sym,Arg1],[]),([X1,Arg1],[]),([X2],[]),([X2,Sym],[]),([Sym],[]),([Arg2],[Arg2]),([N1],[N1])]);mshare([[X1,X2,Sym,Arg1],[X1,Sym,Arg1],[X1,Arg1],[X2],[X2,Sym],[Sym],[Arg2],[N1]]),ground([N,Arity]),linear(Arg2),linear(N1),shlin2([([X1,X2,Sym,Arg1],[]),([X1,Sym,Arg1],[]),([X1,Arg1],[]),([X2],[X2]),([X2,Sym],[]),([Sym],[]),([Arg2],[Arg2]),([N1],[N1])]);mshare([[X1,X2,Sym,Arg1],[X1,Sym,Arg1],[X2,Sym],[Sym],[Arg2],[N1]]),ground([N,Arity]),linear(Arg2),linear(N1),shlin2([([X1,X2,Sym,Arg1],[]),([X1,Sym,Arg1],[]),([X2,Sym],[]),([Sym],[]),([Arg2],[Arg2]),([N1],[N1])]);mshare([[X1,Sym,Arg1],[X1,Arg1],[X2],[Sym],[Arg2],[N1]]),ground([N,Arity]),linear(X2),linear(Arg2),linear(N1),shlin2([([X1,Sym,Arg1],[]),([X1,Arg1],[]),([X2],[X2]),([Sym],[Sym]),([Arg2],[Arg2]),([N1],[N1])]))),
    arg(N,X2,Arg2),
    true((mshare([[X1,X2,Sym,Arg1,Arg2],[X1,Sym,Arg1],[X1,Arg1],[X2,Sym,Arg2],[X2,Arg2],[Sym],[N1]]),ground([N,Arity]),linear(N1),shlin2([([X1,X2,Sym,Arg1,Arg2],[]),([X1,Sym,Arg1],[]),([X1,Arg1],[]),([X2,Sym,Arg2],[]),([X2,Arg2],[]),([Sym],[]),([N1],[N1])]);mshare([[X1,X2,Sym,Arg1,Arg2],[X1,Sym,Arg1],[X1,Arg1],[X2,Sym,Arg2],[X2,Arg2],[Sym],[N1]]),ground([N,Arity]),linear(N1),shlin2([([X1,X2,Sym,Arg1,Arg2],[]),([X1,Sym,Arg1],[]),([X1,Arg1],[]),([X2,Sym,Arg2],[]),([X2,Arg2],[X2,Arg2]),([Sym],[]),([N1],[N1])]);mshare([[X1,X2,Sym,Arg1,Arg2],[X1,Sym,Arg1],[X2,Sym,Arg2],[Sym],[N1]]),ground([N,Arity]),linear(N1),shlin2([([X1,X2,Sym,Arg1,Arg2],[]),([X1,Sym,Arg1],[]),([X2,Sym,Arg2],[]),([Sym],[]),([N1],[N1])]);mshare([[X1,Sym,Arg1],[X1,Arg1],[X2,Arg2],[Sym],[N1]]),ground([N,Arity]),linear(X2),linear(Arg2),linear(N1),shlin2([([X1,Sym,Arg1],[]),([X1,Arg1],[]),([X2,Arg2],[X2,Arg2]),([Sym],[Sym]),([N1],[N1])]))),
    copy2(Arg1,Arg2,Sym),
    true((mshare([[X1,X2,Sym,Arg1,Arg2],[X1,Sym,Arg1],[X1,Arg1],[X2,Sym,Arg2],[X2,Arg2],[Sym],[N1]]),ground([N,Arity]),linear(N1),shlin2([([X1,X2,Sym,Arg1,Arg2],[]),([X1,Sym,Arg1],[]),([X1,Arg1],[]),([X2,Sym,Arg2],[]),([X2,Arg2],[]),([Sym],[]),([N1],[N1])]);mshare([[X1,X2,Sym,Arg1,Arg2],[X1,Sym,Arg1],[X2,Sym,Arg2],[Sym],[N1]]),ground([N,Arity]),linear(N1),shlin2([([X1,X2,Sym,Arg1,Arg2],[]),([X1,Sym,Arg1],[]),([X2,Sym,Arg2],[]),([Sym],[]),([N1],[N1])]))),
    N1 is N+1,
    true((mshare([[X1,X2,Sym,Arg1,Arg2],[X1,Sym,Arg1],[X1,Arg1],[X2,Sym,Arg2],[X2,Arg2],[Sym]]),ground([N,Arity,N1]),shlin2([([X1,X2,Sym,Arg1,Arg2],[]),([X1,Sym,Arg1],[]),([X1,Arg1],[]),([X2,Sym,Arg2],[]),([X2,Arg2],[]),([Sym],[])]);mshare([[X1,X2,Sym,Arg1,Arg2],[X1,Sym,Arg1],[X2,Sym,Arg2],[Sym]]),ground([N,Arity,N1]),shlin2([([X1,X2,Sym,Arg1,Arg2],[]),([X1,Sym,Arg1],[]),([X2,Sym,Arg2],[]),([Sym],[])]))),
    copy2(X1,X2,Sym,N1,Arity),
    true((mshare([[X1,X2,Sym,Arg1,Arg2],[X1,Sym,Arg1],[X1,Arg1],[X2,Sym,Arg2],[X2,Arg2],[Sym]]),ground([N,Arity,N1]),shlin2([([X1,X2,Sym,Arg1,Arg2],[]),([X1,Sym,Arg1],[]),([X1,Arg1],[]),([X2,Sym,Arg2],[]),([X2,Arg2],[]),([Sym],[])]);mshare([[X1,X2,Sym,Arg1,Arg2],[X1,Sym,Arg1],[X2,Sym,Arg2],[Sym]]),ground([N,Arity,N1]),shlin2([([X1,X2,Sym,Arg1,Arg2],[]),([X1,Sym,Arg1],[]),([X2,Sym,Arg2],[]),([Sym],[])]))).

:- true pred retrieve_sym(V,_A,X)
   : ( mshare([[V],[V,_A],[V,_A,X],[_A],[_A,X],[X]]),
       linear(V), shlin2([([V],[V]),([V,_A],[V]),([V,_A,X],[V]),([_A],[]),([_A,X],[]),([X],[])]) )
...
:- true pred retrieve_sym(V,_A,X)
   : ( mshare([[V,_A],[V,_A,X],[_A],[_A,X]]),
       linear(V), shlin2([([V,_A],[V]),([V,_A,X],[V]),([_A],[]),([_A,X],[])]) )
   => ( mshare([[V,_A],[V,_A,X],[_A],[_A,X]]),
        shlin2([([V,_A],[]),([V,_A,X],[]),([_A],[]),([_A,X],[])]) ).
...
retrieve_sym(V,[p(W,X)|_Sym],X) :-
    true((mshare([[V],[V,X],[V,X,_Sym],[V,X,_Sym,W],[V,X,W],[V,_Sym],[V,_Sym,W],[V,W],[X],[X,_Sym],[X,_Sym,W],[X,W],[_Sym],[_Sym,W],[W]]),shlin2([([V],[V]),([V,X],[]),([V,X,_Sym],[]),([V,X,_Sym,W],[]),([V,X,W],[]),([V,_Sym],[V]),([V,_Sym,W],[V]),([V,W],[V]),([X],[]),([X,_Sym],[]),([X,_Sym,W],[]),([X,W],[]),([_Sym],[]),([_Sym,W],[]),([W],[])]);mshare([[V],[V,X],[V,X,_Sym],[V,X,_Sym,W],[V,X,W],[V,_Sym],[V,_Sym,W],[V,W],[X],[_Sym],[W]]),linear(V),shlin2([([V],[V]),([V,X],[V]),([V,X,_Sym],[V]),([V,X,_Sym,W],[V]),([V,X,W],[V]),([V,_Sym],[V]),([V,_Sym,W],[V]),([V,W],[V]),([X],[X]),([_Sym],[_Sym]),([W],[W])]);mshare([[V,X],[V,X,_Sym],[V,X,_Sym,W],[V,X,W],[V,_Sym],[V,_Sym,W],[V,W],[X],[X,_Sym],[X,_Sym,W],[X,W],[_Sym],[_Sym,W],[W]]),shlin2([([V,X],[]),([V,X,_Sym],[]),([V,X,_Sym,W],[]),([V,X,W],[]),([V,_Sym],[V]),([V,_Sym,W],[V]),([V,W],[V]),([X],[]),([X,_Sym],[]),([X,_Sym,W],[]),([X,W],[]),([_Sym],[]),([_Sym,W],[]),([W],[])]))),
    V==W,
    !,
    true((mshare([[V,X,_Sym,W],[V,X,W],[V,_Sym,W],[V,W],[X],[X,_Sym],[_Sym]]),shlin2([([V,X,_Sym,W],[]),([V,X,W],[]),([V,_Sym,W],[V,W]),([V,W],[V,W]),([X],[]),([X,_Sym],[]),([_Sym],[])]);mshare([[V,X,_Sym,W],[V,X,W],[V,_Sym,W],[V,W],[X],[_Sym]]),linear(V),linear(W),shlin2([([V,X,_Sym,W],[V,W]),([V,X,W],[V,W]),([V,_Sym,W],[V,W]),([V,W],[V,W]),([X],[X]),([_Sym],[_Sym])]))).
retrieve_sym(V,[_1|Sym],X) :-
    true((mshare([[V],[V,X],[V,X,_1],[V,X,_1,Sym],[V,X,Sym],[V,_1],[V,_1,Sym],[V,Sym],[X],[X,_1],[X,_1,Sym],[X,Sym],[_1],[_1,Sym],[Sym]]),linear(V),shlin2([([V],[V]),([V,X],[V]),([V,X,_1],[V]),([V,X,_1,Sym],[V]),([V,X,Sym],[V]),([V,_1],[V]),([V,_1,Sym],[V]),([V,Sym],[V]),([X],[]),([X,_1],[]),([X,_1,Sym],[]),([X,Sym],[]),([_1],[]),([_1,Sym],[]),([Sym],[])]);mshare([[V],[V,X,_1],[V,X,_1,Sym],[V,X,Sym],[V,_1],[V,_1,Sym],[V,Sym],[X],[X,_1],[X,_1,Sym],[X,Sym],[_1],[_1,Sym],[Sym]]),linear(V),shlin2([([V],[V]),([V,X,_1],[V]),([V,X,_1,Sym],[V]),([V,X,Sym],[V]),([V,_1],[V]),([V,_1,Sym],[V]),([V,Sym],[V]),([X],[]),([X,_1],[]),([X,_1,Sym],[]),([X,Sym],[]),([_1],[]),([_1,Sym],[]),([Sym],[])]);mshare([[V],[V,X,_1],[V,X,_1,Sym],[V,X,Sym],[V,_1],[V,_1,Sym],[V,Sym],[X],[X,_1],[X,_1,Sym],[X,Sym],[_1],[_1,Sym],[Sym]]),linear(V),shlin2([([V],[V]),([V,X,_1],[V]),([V,X,_1,Sym],[V]),([V,X,Sym],[V]),([V,_1],[V]),([V,_1,Sym],[V]),([V,Sym],[V]),([X],[X]),([X,_1],[]),([X,_1,Sym],[]),([X,Sym],[]),([_1],[]),([_1,Sym],[]),([Sym],[])]);mshare([[V],[V,_1],[V,_1,Sym],[V,Sym],[X],[_1],[Sym]]),linear(V),linear(X),shlin2([([V],[V]),([V,_1],[V]),([V,_1,Sym],[V]),([V,Sym],[V]),([X],[X]),([_1],[_1]),([Sym],[Sym])]);mshare([[V,X,_1],[V,X,_1,Sym],[V,X,Sym],[V,_1],[V,_1,Sym],[V,Sym],[X,_1],[X,_1,Sym],[X,Sym],[_1],[_1,Sym],[Sym]]),linear(V),shlin2([([V,X,_1],[V]),([V,X,_1,Sym],[V]),([V,X,Sym],[V]),([V,_1],[V]),([V,_1,Sym],[V]),([V,Sym],[V]),([X,_1],[]),([X,_1,Sym],[]),([X,Sym],[]),([_1],[]),([_1,Sym],[]),([Sym],[])]))),
    retrieve_sym(V,Sym,X),
    true((mshare([[V,X,_1,Sym],[V,X,Sym],[V,_1,Sym],[V,Sym],[X,_1,Sym],[X,Sym],[_1],[_1,Sym],[Sym]]),shlin2([([V,X,_1,Sym],[]),([V,X,Sym],[]),([V,_1,Sym],[]),([V,Sym],[]),([X,_1,Sym],[]),([X,Sym],[]),([_1],[]),([_1,Sym],[]),([Sym],[])]);mshare([[V,X,_1,Sym],[V,X,Sym],[V,_1,Sym],[V,Sym],[X,Sym],[_1],[Sym]]),shlin2([([V,X,_1,Sym],[]),([V,X,Sym],[]),([V,_1,Sym],[]),([V,Sym],[]),([X,Sym],[]),([_1],[_1]),([Sym],[])]))).
...
varbag(Var,_1,_2) :-
    ...
    var(Var),
    !,
    true((mshare([[Var],[_1]]),ground([_2]),linear(Var),linear(_1),shlin2([([Var],[Var]),([_1],[_1])]);mshare([[Var],[_1],[_2]]),linear(Var),linear(_1),linear(_2),shlin2([([Var],[Var]),([_1],[_1]),([_2],[_2])]))),
    'C'(_1,Var,_2),
    true((mshare([[Var,_1]]),ground([_2]),linear(Var),linear(_1),shlin2([([Var,_1],[Var,_1])]);mshare([[Var,_1],[_1,_2]]),linear(Var),linear(_1),linear(_2),shlin2([([Var,_1],[Var,_1]),([_1,_2],[_1,_2])]))).
varbag(Str,_1,_2) :-
