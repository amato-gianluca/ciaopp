...
:- true pred poly_add(Poly,C,_A)
   : ( mshare([[_A]]),
       var(_A), ground([Poly,C]), linear(_A) )
   => ground([Poly,C,_A]).

:- true pred poly_add(Poly,C,_A)
   : ( (Poly=poly(z,[term(1,1)])),
       mshare([[_A]]),
       var(_A), ground([C]), linear(_A) )
   => ground([C,_A]).
...
:- true pred term_add(Terms1,X,_A)
   : ( (X=[term(_C,_D)|_B]),
       mshare([[_A]]),
       var(_A), ground([Terms1,_B,_C,_D]), linear(_A) )
   => ground([Terms1,_A,_B,_C,_D]).

:- true pred term_add(Terms1,X,_A)
   : ( mshare([[_A]]),
       var(_A), ground([Terms1,X]), linear(_A) )
   => ground([Terms1,X,_A]).
...
:- true pred add_to_order_zero_term(Terms,C2,_A)
   : ( mshare([[_A]]),
       var(_A), ground([Terms,C2]), linear(_A) )
   => ground([Terms,C2,_A]).

:- true pred add_to_order_zero_term(Terms,C2,_A)
   : ( (C2=poly(_B,_C)),
       mshare([[_A]]),
       var(_A), ground([Terms,_B,_C]), linear(_A) )
...
:- true pred poly_exp(N,_1,Result)
   : ( mshare([[Result]]),
       var(Result), ground([N,_1]), linear(Result) )
   => ground([N,_1,Result]).

:- true pred poly_exp(N,_1,Result)
   : ( (N=10),
       mshare([[Result]]),
       var(Result), ground([_1]), linear(Result) )
   => ground([_1,Result]).
...
:- true pred poly_mul(P,C,_A)
   : ( (P=C),
       mshare([[_A]]),
       var(_A), ground([P]), linear(_A) )
   => ground([P,_A]).

:- true pred poly_mul(P,C,_A)
   : ( mshare([[_A]]),
       var(_A), ground([P,C]), linear(_A) )
   => ground([P,C,_A]).
...
:- true pred term_mul(_A,_1,Terms)
   : ( mshare([[Terms]]),
       var(Terms), ground([_A,_1]), linear(Terms) )
   => ground([_A,_1,Terms]).
...
:- true pred single_term_mul(_A,_1,_B)
   : ( (_1=term(_C,_D)),
       mshare([[_B]]),
       var(_B), ground([_A,_C,_D]), linear(_B) )
   => ground([_A,_B,_C,_D]).

:- true pred single_term_mul(_A,_1,_B)
   : ( mshare([[_B]]),
       var(_B), ground([_A,_1]), linear(_B) )
   => ground([_A,_1,_B]).
