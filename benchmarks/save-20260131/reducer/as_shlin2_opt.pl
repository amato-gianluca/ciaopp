...
list_functor_name(Name) :-
    ...
    var(Name),
    !,
    true((fails(_);mshare([[Name],[_4],[_5],[_6]]),linear(Name),linear(_4),linear(_5),linear(_6),shlin2([([Name],[Name]),([_4],[_4]),([_5],[_5]),([_6],[_6])]))),
    functor([_5|_6],Name,_4),
    true((fails(_);mshare([[_5],[_6]]),ground([Name,_4]),linear(_5),linear(_6),shlin2([([_5],[_5]),([_6],[_6])]))).
