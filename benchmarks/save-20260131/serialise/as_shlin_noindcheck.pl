...
numbered(tree(T1,pair(_1,N1),T2),N0,N) :-
    true((mshare([[N],[N,T1],[N,T1,T2],[N,T1,T2,_1],[N,T1,T2,_1,N1],[N,T1,T2,N1],[N,T1,_1],[N,T1,_1,N1],[N,T1,N1],[N,T2],[N,T2,_1],[N,T2,_1,N1],[N,T2,N1],[N,_1],[N,_1,N1],[N,N1],[T1],[T1,T2],[T1,T2,_1],[T1,T2,_1,N1],[T1,T2,N1],[T1,_1],[T1,_1,N1],[T1,N1],[T2],[T2,_1],[T2,_1,N1],[T2,N1],[_1],[_1,N1],[N1],[N2]]),ground([N0]),linear(N2);mshare([[N],[T1],[T1,T2],[T1,T2,_1],[T1,T2,_1,N1],[T1,T2,N1],[T1,_1],[T1,_1,N1],[T1,N1],[T2],[T2,_1],[T2,_1,N1],[T2,N1],[_1],[_1,N1],[N1],[N2]]),ground([N0]),linear(N),linear(N2))),
    numbered(T1,N0,N1),
    true((mshare([[N],[N,T1],[N,T1,T2],[N,T1,T2,_1],[N,T1,_1],[N,T2],[N,T2,_1],[N,_1],[T1],[T1,T2],[T1,T2,_1],[T1,_1],[T2],[T2,_1],[_1],[N2]]),ground([N0,N1]),linear(N2);mshare([[N],[T1],[T1,T2],[T1,T2,_1],[T1,_1],[T2],[T2,_1],[_1],[N2]]),ground([N0,N1]),linear(N),linear(N2))),
    N2 is N1+1,
    true((mshare([[N],[N,T1],[N,T1,T2],[N,T1,T2,_1],[N,T1,_1],[N,T2],[N,T2,_1],[N,_1],[T1],[T1,T2],[T1,T2,_1],[T1,_1],[T2],[T2,_1],[_1]]),ground([N0,N1,N2]);mshare([[N],[T1],[T1,T2],[T1,T2,_1],[T1,_1],[T2],[T2,_1],[_1]]),ground([N0,N1,N2]),linear(N))),
    numbered(T2,N2,N),
    true((
