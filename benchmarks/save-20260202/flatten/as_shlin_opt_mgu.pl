...
find_vars(Term,Vars,Link) :-
    ...
    Term=..[_1|Args],
    true((mshare([[Term,Vars,Args],[Term,Args],[Vars],[Link]]),ground([_1]);mshare([[Term,Vars,Args],[Term,Args],[Vars],[Link]]),ground([_1]),linear(Link);mshare([[Term,Args],[Vars],[Link]]),ground([_1]),linear(Vars),linear(Link);mshare([[Term,Args],[Vars],[Link]]),ground([_1]),linear(Link))),
...
retrieve_sym(V,[_1|Sym],X) :-
    true((mshare([[V],[V,X],[V,X,_1],[V,X,_1,Sym],[V,X,Sym],[V,_1],[V,_1,Sym],[V,Sym],[X],[X,_1],[X,_1,Sym],[X,Sym],[_1],[_1,Sym],[Sym]]),linear(V);mshare([[V],[V,X],[V,X,_1],[V,X,_1,Sym],[V,X,Sym],[V,_1],[V,_1,Sym],[V,Sym],[X],[_1],[_1,Sym],[Sym]]),linear(V);mshare([[V],[V,X,_1],[V,X,_1,Sym],[V,X,Sym],[V,_1],[V,_1,Sym],[V,Sym],[X],[X,_1],[X,_1,Sym],[X,Sym],[_1],[_1,Sym],[Sym]]),linear(V);mshare([[V],[V,_1],[V,_1,Sym],[V,Sym],[X],[_1],[_1,Sym],[Sym]]),linear(V))),
...
varbag(Str,N,Arity,_1,_2) :-
    ...
    true((mshare([[Str],[Str,_1],[_1],[_2],[Arg],[_3],[N1]]),ground([N,Arity]),linear(_2),linear(Arg),linear(_3),linear(N1);mshare([[Str],[Str,_1],[_1],[_2],[Arg],[_3],[N1]]),ground([N,Arity]),linear(Arg),linear(_3),linear(N1);mshare([[Str],[Str,_1],[_1],[Arg],[_3],[N1]]),ground([N,Arity,_2]),linear(Arg),linear(_3),linear(N1);mshare([[Str],[_1],[_2],[Arg],[_3],[N1]]),ground([N,Arity]),linear(_1),linear(_2),linear(Arg),linear(_3),linear(N1);mshare([[Str],[_1],[Arg],[_3],[N1]]),ground([N,Arity,_2]),linear(_1),linear(Arg),linear(_3),linear(N1))),
    arg(N,Str,Arg),
    true((mshare([[Str],[Str,_1],[Str,_1,Arg],[Str,Arg],[_1],[_2],[_3],[N1]]),ground([N,Arity]),linear(_2),linear(_3),linear(N1);mshare([[Str],[Str,_1],[Str,_1,Arg],[Str,Arg],[_1],[_2],[_3],[N1]]),ground([N,Arity]),linear(_3),linear(N1);mshare([[Str],[Str,_1],[Str,_1,Arg],[Str,Arg],[_1],[_3],[N1]]),ground([N,Arity,_2]),linear(_3),linear(N1);mshare([[Str],[Str,Arg],[_1],[_2],[_3],[N1]]),ground([N,Arity]),linear(_1),linear(_2),linear(_3),linear(N1);mshare([[Str],[Str,Arg],[_1],[_3],[N1]]),ground([N,Arity,_2]),linear(_1),linear(_3),linear(N1))),
    varbag(Arg,_1,_3),
