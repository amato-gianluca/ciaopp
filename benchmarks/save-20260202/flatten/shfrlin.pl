...
treat_disj([disj((A;B),N,X,C)|Disjs],DummyClauses,Link) :-
    ...
    true((
        mshare([[DummyClauses],[Disjs],[Disjs,X],[Disjs,X,C,A,B,Vars,CVars],[Disjs,X,C,A,B,Vars,CVars,Args],[Disjs,X,C,A,Vars,CVars],[Disjs,X,C,A,Vars,CVars,Args],[Disjs,X,C,B,Vars,CVars],[Disjs,X,C,B,Vars,CVars,Args],[Disjs,X,C,CVars],[Disjs,X,A,B,Vars],[Disjs,X,A,B,Vars,Args],[Disjs,X,A,Vars],[Disjs,X,A,Vars,Args],[Disjs,X,B,Vars],[Disjs,X,B,Vars,Args],[Disjs,C,A,B,Vars,CVars],[Disjs,C,A,B,Vars,CVars,Args],[Disjs,C,A,Vars,CVars],[Disjs,C,A,Vars,CVars,Args],[Disjs,C,B,Vars,CVars],[Disjs,C,B,Vars,CVars,Args],[Disjs,C,CVars],[Disjs,A,B,Vars],[Disjs,A,B,Vars,Args],[Disjs,A,Vars],[Disjs,A,Vars,Args],[Disjs,B,Vars],[Disjs,B,Vars,Args],[X],[X,C,A,B,Vars,CVars],[X,C,A,B,Vars,CVars,Args],[X,C,A,Vars,CVars],[X,C,A,Vars,CVars,Args],[X,C,B,Vars,CVars],[X,C,B,Vars,CVars,Args],[X,C,CVars],[X,A,B,Vars],[X,A,B,Vars,Args],[X,A,Vars],[X,A,Vars,Args],[X,B,Vars],[X,B,Vars,Args],[C,A,B,Vars,CVars],[C,A,B,Vars,CVars,Args],[C,A,Vars,CVars],[C,A,Vars,CVars,Args],[C,B,Vars,CVars],[C,B,Vars,CVars,Args],[C,CVars],[A,B,Vars],[A,B,Vars,Args],[A,Vars],[A,Vars,Args],[B,Vars],[B,Vars,Args],[Rest]]),
        var(DummyClauses),
        var(Rest),
        ground([Link,N,Name]),
        linear(DummyClauses),
    ...
    X=..[Name|Args],
    true((
        mshare([[DummyClauses],[Disjs],[Disjs,X,C,A,B,Vars,CVars,Args],[Disjs,X,C,A,Vars,CVars,Args],[Disjs,X,C,B,Vars,CVars,Args],[Disjs,X,A,B,Vars,Args],[Disjs,X,A,Vars,Args],[Disjs,X,B,Vars,Args],[Disjs,C,A,B,Vars,CVars],[Disjs,C,A,Vars,CVars],[Disjs,C,B,Vars,CVars],[Disjs,C,CVars],[Disjs,A,B,Vars],[Disjs,A,Vars],[Disjs,B,Vars],[X,C,A,B,Vars,CVars,Args],[X,C,A,Vars,CVars,Args],[X,C,B,Vars,CVars,Args],[X,A,B,Vars,Args],[X,A,Vars,Args],[X,B,Vars,Args],[C,A,B,Vars,CVars],[C,A,Vars,CVars],[C,B,Vars,CVars],[C,CVars],[A,B,Vars],[A,Vars],[B,Vars],[Rest]]),
        var(DummyClauses),
        var(Rest),
        ground([Link,N,Name]),
        linear(DummyClauses),
    ...
    true((
        mshare([[DummyClauses],[DummyClauses,Disjs,X,C,A,B,Vars,CVars,Args],[DummyClauses,Disjs,X,C,A,Vars,CVars,Args],[DummyClauses,Disjs,X,C,B,Vars,CVars,Args],[DummyClauses,Disjs,X,A,B,Vars,Args],[DummyClauses,Disjs,X,A,Vars,Args],[DummyClauses,Disjs,X,B,Vars,Args],[DummyClauses,Disjs,C,A,B,Vars,CVars],[DummyClauses,Disjs,C,A,Vars,CVars],[DummyClauses,Disjs,C,B,Vars,CVars],[DummyClauses,Disjs,A,B,Vars],[DummyClauses,Disjs,A,Vars],[DummyClauses,Disjs,B,Vars],[DummyClauses,X,C,A,B,Vars,CVars,Args],[DummyClauses,X,C,A,Vars,CVars,Args],[DummyClauses,X,C,B,Vars,CVars,Args],[DummyClauses,X,A,B,Vars,Args],[DummyClauses,X,A,Vars,Args],[DummyClauses,X,B,Vars,Args],[DummyClauses,C,A,B,Vars,CVars],[DummyClauses,C,A,Vars,CVars],[DummyClauses,C,B,Vars,CVars],[DummyClauses,A,B,Vars],[DummyClauses,A,Vars],[DummyClauses,B,Vars],[DummyClauses,Rest],[Disjs],[Disjs,X,C,A,B,Vars,CVars,Args],[Disjs,X,C,A,Vars,CVars,Args],[Disjs,X,C,B,Vars,CVars,Args],[Disjs,X,A,B,Vars,Args],[Disjs,X,A,Vars,Args],[Disjs,X,B,Vars,Args],[Disjs,C,A,B,Vars,CVars],[Disjs,C,A,Vars,CVars],[Disjs,C,B,Vars,CVars],[Disjs,C,CVars],[Disjs,A,B,Vars],[Disjs,A,Vars],[Disjs,B,Vars],[X,C,A,B,Vars,CVars,Args],[X,C,A,Vars,CVars,Args],[X,C,B,Vars,CVars,Args],[X,A,B,Vars,Args],[X,A,Vars,Args],[X,B,Vars,Args],[C,A,B,Vars,CVars],[C,A,Vars,CVars],[C,B,Vars,CVars],[C,CVars],[A,B,Vars],[A,Vars],[B,Vars]]),
        var(Rest),
        ground([Link,N,Name]),
        linear(Rest)
    )),
    ...
    true((
        mshare([[DummyClauses],[DummyClauses,Disjs,X,C,A,B,Vars,CVars,Args],[DummyClauses,Disjs,X,C,A,B,Vars,CVars,Args,Rest],[DummyClauses,Disjs,X,C,A,Vars,CVars,Args],[DummyClauses,Disjs,X,C,A,Vars,CVars,Args,Rest],[DummyClauses,Disjs,X,C,B,Vars,CVars,Args],[DummyClauses,Disjs,X,C,B,Vars,CVars,Args,Rest],[DummyClauses,Disjs,X,A,B,Vars,Args],[DummyClauses,Disjs,X,A,B,Vars,Args,Rest],[DummyClauses,Disjs,X,A,Vars,Args],[DummyClauses,Disjs,X,A,Vars,Args,Rest],[DummyClauses,Disjs,X,B,Vars,Args],[DummyClauses,Disjs,X,B,Vars,Args,Rest],[DummyClauses,Disjs,C,A,B,Vars,CVars],[DummyClauses,Disjs,C,A,B,Vars,CVars,Rest],[DummyClauses,Disjs,C,A,Vars,CVars],[DummyClauses,Disjs,C,A,Vars,CVars,Rest],[DummyClauses,Disjs,C,B,Vars,CVars],[DummyClauses,Disjs,C,B,Vars,CVars,Rest],[DummyClauses,Disjs,C,CVars,Rest],[DummyClauses,Disjs,A,B,Vars],[DummyClauses,Disjs,A,B,Vars,Rest],[DummyClauses,Disjs,A,Vars],[DummyClauses,Disjs,A,Vars,Rest],[DummyClauses,Disjs,B,Vars],[DummyClauses,Disjs,B,Vars,Rest],[DummyClauses,Disjs,Rest],[DummyClauses,X,C,A,B,Vars,CVars,Args],[DummyClauses,X,C,A,Vars,CVars,Args],[DummyClauses,X,C,B,Vars,CVars,Args],[DummyClauses,X,A,B,Vars,Args],[DummyClauses,X,A,Vars,Args],[DummyClauses,X,B,Vars,Args],[DummyClauses,C,A,B,Vars,CVars],[DummyClauses,C,A,Vars,CVars],[DummyClauses,C,B,Vars,CVars],[DummyClauses,A,B,Vars],[DummyClauses,A,Vars],[DummyClauses,B,Vars],[DummyClauses,Rest],[Disjs],[Disjs,X,C,A,B,Vars,CVars,Args],[Disjs,X,C,A,Vars,CVars,Args],[Disjs,X,C,B,Vars,CVars,Args],[Disjs,X,A,B,Vars,Args],[Disjs,X,A,Vars,Args],[Disjs,X,B,Vars,Args],[Disjs,C,A,B,Vars,CVars],[Disjs,C,A,Vars,CVars],[Disjs,C,B,Vars,CVars],[Disjs,C,CVars],[Disjs,A,B,Vars],[Disjs,A,Vars],[Disjs,B,Vars],[X,C,A,B,Vars,CVars,Args],[X,C,A,Vars,CVars,Args],[X,C,B,Vars,CVars,Args],[X,A,B,Vars,Args],[X,A,Vars,Args],[X,B,Vars,Args],[C,A,B,Vars,CVars],[C,A,Vars,CVars],[C,B,Vars,CVars],[C,CVars],[A,B,Vars],[A,Vars],[B,Vars]]),
        ground([Link,N,Name])
    )).
