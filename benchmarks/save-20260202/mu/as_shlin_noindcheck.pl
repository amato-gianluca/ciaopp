...
theorem(R,Depth,[[N|R]|P]) :-
    true((mshare([[R],[P],[N],[D],[S]]),ground([Depth]),linear(P),linear(N),linear(D),linear(S);mshare([[P],[N],[D],[S]]),ground([R,Depth]),linear(P),linear(N),linear(D),linear(S))),
    Depth>0,
    true((mshare([[R],[P],[N],[D],[S]]),ground([Depth]),linear(P),linear(N),linear(D),linear(S);mshare([[P],[N],[D],[S]]),ground([R,Depth]),linear(P),linear(N),linear(D),linear(S))),
    D is Depth-1,
    true((mshare([[R],[P],[N],[S]]),ground([Depth,D]),linear(P),linear(N),linear(S);mshare([[P],[N],[S]]),ground([R,Depth,D]),linear(P),linear(N),linear(S))),
    theorem(S,D,P),
    true((mshare([[R],[N]]),ground([Depth,P,D,S]),linear(N);mshare([[N]]),ground([R,Depth,P,D,S]),linear(N))),
    rule(N,S,R),
    true(ground([R,Depth,P,N,D,S])).

:- true pred rule(_A,S,R)
   : ( mshare([[_A]]),
       ground([S,R]), linear(_A) )
   => ground([_A,S,R]).
