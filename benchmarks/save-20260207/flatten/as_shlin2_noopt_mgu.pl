...
copy2(V1,V2,Sym) :-
    true((mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),shlin2([([V1],[]),([V1,V2,Sym],[]),([V1,Sym],[]),([V2],[]),([V2,Sym],[]),([Sym],[])]);mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),shlin2([([V1],[]),([V1,V2,Sym],[]),([V1,Sym],[]),([V2],[V2]),([V2,Sym],[]),([Sym],[])]);mshare([[V1],[V1,Sym],[V2],[Sym]]),linear(V2),shlin2([([V1],[]),([V1,Sym],[]),([V2],[V2]),([Sym],[])]);mshare([[V1],[V1,Sym],[V2],[Sym]]),linear(V2),shlin2([([V1],[]),([V1,Sym],[]),([V2],[V2]),([Sym],[Sym])]))),
    var(V1),
    !,
    true((mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),linear(V1),shlin2([([V1],[V1]),([V1,V2,Sym],[V1]),([V1,Sym],[V1]),([V2],[]),([V2,Sym],[]),([Sym],[])]);mshare([[V1],[V1,V2,Sym],[V1,Sym],[V2],[V2,Sym],[Sym]]),linear(V1),shlin2([([V1],[V1]),([V1,V2,Sym],[V1]),([V1,Sym],[V1]),([V2],[V2]),([V2,Sym],[]),([Sym],[])]);mshare([[V1],[V1,Sym],[V2],[Sym]]),linear(V1),linear(V2),shlin2([([V1],[V1]),([V1,Sym],[V1]),([V2],[V2]),([Sym],[])]);mshare([[V1],[V1,Sym],[V2],[Sym]]),linear(V1),linear(V2),shlin2([([V1],[V1]),([V1,Sym],[V1]),([V2],[V2]),([Sym],[Sym])]))),
...
copy2(X1,X2,Sym) :-
    ...
    true((mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym]]),ground([Name,Arity]),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[]),([X2,Sym],[]),([Sym],[])]);mshare([[X1],[X1,X2,Sym],[X1,Sym],[X2],[X2,Sym],[Sym]]),ground([Name,Arity]),shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[X2]),([X2,Sym],[]),([Sym],[])]);mshare([[X1],[X1,Sym],[X2],[Sym]]),ground([Name,Arity]),linear(X2),shlin2([([X1],[]),([X1,Sym],[]),([X2],[X2]),([Sym],[])]);mshare([[X1],[X1,Sym],[X2],[Sym]]),ground([Name,Arity]),linear(X2),shlin2([([X1],[]),([X1,Sym],[]),([X2],[X2]),([Sym],[Sym])]))),
    ...
    true((
        ...
        ground([Name,Arity]),
        shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,Sym],[]),([X2],[]),([X2,Sym],[]),([Sym],[])])
    )).
...
copy2(_X1,_X2,_Sym,N,Arity) :-
    true((mshare([[_X1],[_X1,_X2,_Sym],[_X1,_Sym],[_X2],[_X2,_Sym],[_Sym]]),ground([N,Arity]),shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[]),([_X2,_Sym],[]),([_Sym],[])]);mshare([[_X1],[_X1,_X2,_Sym],[_X1,_Sym],[_X2],[_X2,_Sym],[_Sym]]),ground([N,Arity]),shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[_X2]),([_X2,_Sym],[]),([_Sym],[])]);mshare([[_X1],[_X1,_Sym],[_X2],[_Sym]]),ground([N,Arity]),linear(_X2),shlin2([([_X1],[]),([_X1,_Sym],[]),([_X2],[_X2]),([_Sym],[])]);mshare([[_X1],[_X1,_Sym],[_X2],[_Sym]]),ground([N,Arity]),linear(_X2),shlin2([([_X1],[]),([_X1,_Sym],[]),([_X2],[_X2]),([_Sym],[_Sym])]))),
    N>Arity,
    !,
    true((mshare([[_X1],[_X1,_X2,_Sym],[_X1,_Sym],[_X2],[_X2,_Sym],[_Sym]]),ground([N,Arity]),shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[]),([_X2,_Sym],[]),([_Sym],[])]);mshare([[_X1],[_X1,_X2,_Sym],[_X1,_Sym],[_X2],[_X2,_Sym],[_Sym]]),ground([N,Arity]),shlin2([([_X1],[]),([_X1,_X2,_Sym],[]),([_X1,_Sym],[]),([_X2],[_X2]),([_X2,_Sym],[]),([_Sym],[])]);mshare([[_X1],[_X1,_Sym],[_X2],[_Sym]]),ground([N,Arity]),linear(_X2),shlin2([([_X1],[]),([_X1,_Sym],[]),([_X2],[_X2]),([_Sym],[])]);mshare([[_X1],[_X1,_Sym],[_X2],[_Sym]]),ground([N,Arity]),linear(_X2),shlin2([([_X1],[]),([_X1,_Sym],[]),([_X2],[_X2]),([_Sym],[_Sym])]))).
copy2(X1,X2,Sym,N,Arity) :-
    ...
    true((
        ...
        ground([N,Arity,N1]),
        shlin2([([X1],[]),([X1,X2,Sym],[]),([X1,X2,Sym,Arg1],[]),([X1,X2,Sym,Arg1,Arg2],[]),([X1,X2,Sym,Arg2],[]),([X1,Sym],[]),([X1,Sym,Arg1],[]),([X1,Arg1],[]),([X2],[]),([X2,Sym],[]),([X2,Sym,Arg2],[]),([X2,Arg2],[]),([Sym],[])])
    )).
