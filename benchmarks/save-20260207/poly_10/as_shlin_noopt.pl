...
term_add([term(E,C1)|Terms1],[term(E,C2)|Terms2],[term(E,C)|Terms]) :-
    ...
    poly_add(C1,C2,C),
    true((mshare([[Terms]]),ground([Terms1,E,C1,Terms2,C2,C]);mshare([[Terms]]),ground([Terms1,E,C1,Terms2,C2,C]),linear(Terms))),
    term_add(Terms1,Terms2,Terms),
...
mul_through([term(E,Term)|Terms],Poly,[term(E,NewTerm)|NewTerms]) :-
    ...
    true((mshare([[NewTerms]]),ground([Poly,Terms,E,Term,NewTerm]);mshare([[NewTerms]]),ground([Poly,Terms,E,Term,NewTerm]),linear(NewTerms))),
