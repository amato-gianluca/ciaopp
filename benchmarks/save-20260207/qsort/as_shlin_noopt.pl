...
:- true pred partition(_A,Y,L1,L2)
   : ( mshare([[L1],[L2]]),
       ground([_A,Y]), linear(L1), linear(L2) )
   => ground([_A,Y,L1,L2]).

:- true pred partition(_A,Y,L1,L2)
   : ( mshare([[L1],[L2]]),
       ground([_A,Y]), linear(L2) )
   => ground([_A,Y,L1,L2]).
...
:- true pred partition(_A,Y,L1,L2)
   : ( mshare([[L1],[L2]]),
       ground([_A,Y]), linear(L1) )
   => ground([_A,Y,L1,L2]).

partition([X|L],Y,[X|L1],L2) :-
    true((mshare([[L2],[L1]]),ground([Y,X,L]);mshare([[L2],[L1]]),ground([Y,X,L]),linear(L1))),
    X=<Y,
    !,
    true((mshare([[L2],[L1]]),ground([Y,X,L]);mshare([[L2],[L1]]),ground([Y,X,L]),linear(L1))),
    partition(L,Y,L1,L2),
...
partition([X|L],Y,L1,[X|L2]) :-
    true((mshare([[L1],[L2]]),ground([Y,X,L]);mshare([[L1],[L2]]),ground([Y,X,L]),linear(L2))),
    partition(L,Y,L1,L2),
