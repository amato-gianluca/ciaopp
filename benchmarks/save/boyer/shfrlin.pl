...
'tautology/3/1/$disj/1'(Wff,Tlist,Flist) :-
    ...
    true(fails(_)).
'tautology/3/1/$disj/1'(Wff,Tlist,Flist) :-
    true((mshare([[Wff],[Wff,Tlist],[Wff,Tlist,Flist],[Wff,Flist],[Tlist],[Tlist,Flist],[Flist],[If],[Then],[Else]]),var(If),var(Then),var(Else),linear(If),linear(Then),linear(Else);mshare([[Wff],[Wff,Tlist],[Tlist],[If],[Then],[Else]]),var(If),var(Then),var(Else),ground([Flist]),linear(If),linear(Then),linear(Else);mshare([[Wff],[Wff,Flist],[Flist],[If],[Then],[Else]]),var(If),var(Then),var(Else),ground([Tlist]),linear(If),linear(Then),linear(Else);mshare([[Wff],[If],[Then],[Else]]),var(If),var(Then),var(Else),ground([Tlist,Flist]),linear(If),linear(Then),linear(Else))),
    Wff=if(If,Then,Else),
    !,
...
:- true pred rewrite(Atom,New)
   : ( mshare([[New]]),
       var(New), ground([Atom]), linear(New) )
   => ( mshare([[New]]),
        ground([Atom]) ).
...
rewrite(Atom,Atom) :-
    ...
    true(ground([Atom])).
rewrite(Old,New) :-
    true((mshare([[Old],[New],[F],[N],[Mid]]),var(New),var(F),var(N),var(Mid),linear(New),linear(F),linear(N),linear(Mid);mshare([[Old],[New],[F],[N],[Mid]]),var(F),var(N),var(Mid),linear(F),linear(N),linear(Mid);mshare([[New],[F],[N],[Mid]]),var(New),var(F),var(N),var(Mid),ground([Old]),linear(New),linear(F),linear(N),linear(Mid);mshare([[New],[F],[N],[Mid]]),var(F),var(N),var(Mid),ground([Old]),linear(F),linear(N),linear(Mid))),
    functor(Old,F,N),
    true((mshare([[Old],[New],[Mid]]),var(New),var(Mid),ground([F,N]),linear(New),linear(Mid);mshare([[Old],[New],[Mid]]),var(Mid),ground([F,N]),linear(Mid);mshare([[New],[Mid]]),var(New),var(Mid),ground([Old,F,N]),linear(New),linear(Mid);mshare([[New],[Mid]]),var(Mid),ground([Old,F,N]),linear(Mid))),
    functor(Mid,F,N),
    true((mshare([[Old],[New],[Mid]]),ground([F,N]);mshare([[Old],[New],[Mid]]),var(New),ground([F,N]),linear(New);mshare([[New],[Mid]]),ground([Old,F,N]);mshare([[New],[Mid]]),var(New),ground([Old,F,N]),linear(New))),
...
'rewrite/2/2/$disj/1'(New,Mid) :-
    true((mshare([[New],[Mid],[Next]]),var(New),var(Next),linear(New),linear(Next);mshare([[New],[Mid],[Next]]),var(Next),linear(Next))),
    equal(Mid,Next),
    true((mshare([[New],[Mid],[Mid,Next]]);mshare([[New],[Mid],[Mid,Next]]),var(New),linear(New))),
    rewrite(Next,New),
    true(mshare([[New],[Mid],[Mid,Next]])).
'rewrite/2/2/$disj/1'(New,Mid) :-
    true((mshare([[New],[Mid]]);mshare([[New],[Mid]]),var(New),linear(New))),
    New=Mid,
    true(mshare([[New,Mid]])).
...
rewrite_args(N,Old,Mid) :-
    true((mshare([[Old],[Mid],[OldArg],[MidArg],[N1]]),var(OldArg),var(MidArg),var(N1),ground([N]),linear(OldArg),linear(MidArg),linear(N1);mshare([[Mid],[OldArg],[MidArg],[N1]]),var(OldArg),var(MidArg),var(N1),ground([N,Old]),linear(OldArg),linear(MidArg),linear(N1))),
    arg(N,Old,OldArg),
    true((mshare([[Old],[Old,OldArg],[Mid],[MidArg],[N1]]),var(MidArg),var(N1),ground([N]),linear(MidArg),linear(N1);mshare([[Mid],[MidArg],[N1]]),var(MidArg),var(N1),ground([N,Old,OldArg]),linear(MidArg),linear(N1))),
    arg(N,Mid,MidArg),
    true((mshare([[Old],[Old,OldArg],[Mid],[Mid,MidArg],[N1]]),var(N1),ground([N]),linear(N1);mshare([[Mid],[Mid,MidArg],[N1]]),var(N1),ground([N,Old,OldArg]),linear(N1))),
