...
:- true pred init(N,_1,_2,_3,_4,_5)
   : ( (_1=_2),
       mshare([[_5]]),
       var(_5), ground([N,_1,_3,_4]), linear(_5) )
   => ( mshare([[_5]]),
        ground([N,_1,_3,_4]) ).

:- true pred init(N,_1,_2,_3,_4,_5)
   : ( mshare([[_5]]),
       var(_5), ground([N,_1,_2,_3,_4]), linear(_5) )
   => ( mshare([[_5]]),
...
:- true pred fill(N,L,_A)
   : ( (L=[pattern(_C)|_B]),
       mshare([[_A]]),
       var(_A), ground([N,_B,_C]), linear(_A) )
   => ground([N,_A,_B,_C]).
...
randomize(In,[X|Out],Rand) :-
    ...
    split(N,In,X,In1),
    true((
        mshare([[In,X],[In,X,In1],[In,In1],[Out]]),
        var(Out),
        ground([Rand,Lin,Rand1,N]),
        linear(Out)
    )),
...
:- true pred split(N,_A,X,Xs)
   : ( mshare([[_A],[X],[Xs]]),
       var(X), var(Xs), ground([N]), linear(X), linear(Xs) )
...
split(N,[X|Xs],RemovedElt,[X|Ys]) :-
    true((
        mshare([[RemovedElt],[X],[X,Xs],[Xs],[Ys],[N1]]),
        var(RemovedElt),
        var(Ys),
        var(N1),
        ground([N]),
    ...
    N1 is N-1,
    true((
        mshare([[RemovedElt],[X],[X,Xs],[Xs],[Ys]]),
        var(RemovedElt),
        var(Ys),
        ground([N,N1]),
        linear(RemovedElt),
...
:- true pred investigate(_A,_1)
   : ( (_1=[[star(_B),_C,star(_D),_C,a,star(_B),a,star(_D),star(_B)],[star(_B),star(_D),star(_D),star(_B),[star(_B)],[star(_D)]],[_E,_F,star(_G),[b,a],star(_H),_I,_J]]),
       ...
       var(_B), var(_C), var(_D), var(_E), var(_F), var(_G), var(_H), var(_I), var(_J), linear(_B), linear(_C), linear(_D), linear(_E), linear(_F), linear(_G), linear(_H), linear(_I), linear(_J) )
...
:- true pred get_pats(Npats,Ipats,Result)
   : ( mshare([[Result]]),
       var(Result), ground([Npats,Ipats]), linear(Result) )
...
:- true pred get_pats(N,_1,Ys,_2)
   : ( mshare([[Ys]]),
       var(Ys), ground([N,_1,_2]), linear(Ys) )
   => ground([N,_1,Ys,_2]).

:- true pred get_pats(N,_1,Ys,_2)
   : ( (_1=_2),
       mshare([[Ys]]),
       var(Ys), ground([N,_1]), linear(Ys) )
   => ground([N,_1,Ys]).
...
property([Prop|_1],P,Val) :-
    ...
    arg(1,Prop,Val),
    true((
        mshare([[Val,Prop],[Val,Prop,_1],[Prop],[Prop,_1],[_1]]),
        ground([P,_2])
    )).
...
match([X|PRest],[Y|SRest]) :-
    ...
    var(Y),
    !,
    true((mshare([[X],[X,PRest],[X,PRest,Y],[X,PRest,Y,SRest],[X,PRest,SRest],[X,Y],[X,Y,SRest],[X,SRest],[PRest],[PRest,Y],[PRest,Y,SRest],[PRest,SRest],[Y],[Y,SRest],[SRest]]),var(Y),linear(Y);mshare([[X],[X,PRest],[PRest],[Y],[Y,SRest],[SRest]]),var(Y),linear(Y))),
    X=Y,
...
match(List,[Y|Rest]) :-
    true((mshare([[List],[List,Y],[List,Y,Rest],[List,Rest],[Y],[Y,Rest],[Rest],[X],[SRest]]),var(X),var(SRest),linear(X),linear(SRest);mshare([[List],[Y],[Y,Rest],[Rest],[X],[SRest]]),var(X),var(SRest),linear(X),linear(SRest))),
    nonvar(Y),
    true((mshare([[List],[List,Y],[List,Y,Rest],[List,Rest],[Y],[Y,Rest],[Rest],[X],[SRest]]),var(X),var(SRest),linear(X),linear(SRest);mshare([[List],[Y],[Y,Rest],[Rest],[X],[SRest]]),var(X),var(SRest),linear(X),linear(SRest))),
    Y=star(X),
    !,
    true((mshare([[List],[List,Y,Rest,X],[List,Y,X],[List,Rest],[Y,Rest,X],[Y,X],[Rest],[SRest]]),var(SRest),linear(SRest);mshare([[List],[Y,Rest,X],[Y,X],[Rest],[SRest]]),var(SRest),linear(SRest))),
    '$concat'(X,SRest,List),
...
'$concat'([],L,L).
'$concat'([X|L1],L2,[X|L3]) :-
    true((mshare([[L2],[X],[X,L1],[X,L1,L3],[X,L3],[L1],[L1,L3],[L3]]),var(L2),linear(L2);mshare([[L2],[X],[X,L1],[X,L1,L3],[X,L3],[L1],[L3]]),var(L2),linear(L2))),
    '$concat'(L1,L2,L3),
