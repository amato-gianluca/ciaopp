...
:- true pred derive(S,G,SL,GL,D,B)
   : ( (S=[m,i]), (SL=1), (B=0),
       mshare([[D]]),
       ground([G,GL]), linear(D) )
   => ground([G,GL,D]).

:- true pred derive(S,G,SL,GL,D,B)
   : ( mshare([[D]]),
       ground([S,G,SL,GL,B]), linear(D) )
...
:- true pred derive2(S,G,SL,GL,_1,_A,_2)
   : ( (_1=1),
       mshare([[_A]]),
       ground([S,G,SL,GL,_2]), linear(_A) )
   => ground([S,G,SL,GL,_A,_2]).

:- true pred derive2(S,G,SL,GL,_1,_A,_2)
   : ( mshare([[_A]]),
       ground([S,G,SL,GL,_1,_2]), linear(_A) )
...
:- true pred rule(_A,_B,L1,L2,Pin,Pout,N)
   : ( mshare([[_B],[L2],[Pout],[N]]),
       ground([_A,L1,Pin]), linear(_B), linear(L2), linear(Pout), linear(N) )
...
:- true pred rule(_A,L,L1,L2,Pin,Pout,Pos,_1,N,_2,_3)
   : ( (Pos=1), (_1=i), (_2=_3),
       ...
       ground([_A,L1,Pin]), linear(L), linear(L2), linear(Pout), linear(N), linear(_2) )
   => ( mshare([[_2]]),
        ground([_A,L,L1,L2,Pin,Pout,N]) ).

:- true pred rule(_A,L,L1,L2,Pin,Pout,Pos,_1,N,_2,_3)
   : ( mshare([[L],[L2],[Pout],[N],[_2,_3]]),
       ground([_A,L1,Pin,Pos,_1]), linear(L), linear(L2), linear(Pout), linear(N), linear(_2), linear(_3) )
   => ( mshare([[_2,_3]]),
