...
theorem(R,Depth,[[N|R]|P]) :-
    true((mshare([[R],[R,P],[R,P,N],[R,N],[P],[P,N],[N],[D],[S]]),ground([Depth]);mshare([[P],[P,N],[N],[D],[S]]),ground([R,Depth]))),
    Depth>0,
    true((mshare([[R],[R,P],[R,P,N],[R,N],[P],[P,N],[N],[D],[S]]),ground([Depth]);mshare([[P],[P,N],[N],[D],[S]]),ground([R,Depth]))),
    D is Depth-1,
    true((mshare([[R],[R,P],[R,P,N],[R,N],[P],[P,N],[N],[S]]),ground([Depth,D]);mshare([[P],[P,N],[N],[S]]),ground([R,Depth,D]))),
    theorem(S,D,P),
    true((mshare([[R],[R,N],[N]]),ground([Depth,P,D,S]);mshare([[N]]),ground([R,Depth,P,D,S]))),
    rule(N,S,R),
