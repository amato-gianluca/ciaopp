...
select_vector([Gk|Gks],NumVars,NumGs,Gs,GjIn,Vin,TypeIn,Nin,GjOut,Vout,TypeOut,Nout) :-
    true((mshare([[GjOut],[Vout],[TypeOut],[Nout],[K],[Tk],[Gj],[V],[Type],[N]]),ground([NumVars,NumGs,Gs,GjIn,Vin,TypeIn,Nin,Gk,Gks]),linear(GjOut),linear(Vout),linear(TypeOut),linear(Nout),linear(K),linear(Tk),linear(Gj),linear(V),linear(Type),linear(N);mshare([[GjOut],[Vout],[TypeOut],[Nout],[K],[Tk],[Gj],[V],[Type],[N]]),ground([NumVars,NumGs,Gs,GjIn,Vin,TypeIn,Nin,Gk,Gks]),linear(K),linear(Tk),linear(Gj),linear(V),linear(Type),linear(N))),
    function_number(Gk,K),
    true((
...
cover_vector(exp,[I|_3],_1,Gj,V,_2,NumGs,GsIn,NumGs,GsOut) :-
    true((mshare([[_1],[GsOut],[Gi],[Ti]]),ground([Gj,V,_2,NumGs,GsIn,I,_3]),linear(_1),linear(Gi),linear(Ti);mshare([[GsOut],[Gi],[Ti]]),ground([_1,Gj,V,_2,NumGs,GsIn,I,_3]),linear(Gi),linear(Ti))),
    function(I,GsIn,Gi),
...
cover_vector(exp,[_2|IPs],_1,Gj,V,NumVars,NumGs,GsIn,NumGs,GsOut) :-
    true((mshare([[_1],[GsOut],[_3]]),ground([Gj,V,NumVars,NumGs,GsIn,_2,IPs]),linear(_1),linear(_3);mshare([[GsOut],[_3]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,_2,IPs]),linear(_3))),
...
cover_vector(var,_1,[I|_2],Gj,V,NumVars,NumGs,GsIn,NumGs,GsOut) :-
    true((mshare([[_1],[GsOut],[Gi],[Fi]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(_1),linear(Gi),linear(Fi);mshare([[GsOut],[Gi],[Fi]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(Gi),linear(Fi))),
    I<NumVars,
    true((mshare([[_1],[GsOut],[Gi],[Fi]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(_1),linear(Gi),linear(Fi);mshare([[GsOut],[Gi],[Fi]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(Gi),linear(Fi))),
    function(I,GsIn,Gi),
...
cover_vector(var,_1,[_2|CIs],Gj,V,NumVars,NumGs,GsIn,NumGs,GsOut) :-
    true((mshare([[_1],[GsOut],[_3]]),ground([Gj,V,NumVars,NumGs,GsIn,_2,CIs]),linear(_1),linear(_3);mshare([[GsOut],[_3]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,_2,CIs]),linear(_3))),
...
cover_vector(fcn,_1,[I|_2],Gj,V,NumVars,NumGs,GsIn,NumGs,GsOut) :-
    true((mshare([[_1],[GsOut],[Gi],[Fi],[Ti],[Fj]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(_1),linear(Gi),linear(Fi),linear(Ti),linear(Fj);mshare([[GsOut],[Gi],[Fi],[Ti],[Fj]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(Gi),linear(Fi),linear(Ti),linear(Fj))),
    I>=NumVars,
    true((mshare([[_1],[GsOut],[Gi],[Fi],[Ti],[Fj]]),ground([Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(_1),linear(Gi),linear(Fi),linear(Ti),linear(Fj);mshare([[GsOut],[Gi],[Fi],[Ti],[Fj]]),ground([_1,Gj,V,NumVars,NumGs,GsIn,I,_2]),linear(Gi),linear(Fi),linear(Ti),linear(Fj))),
    function(I,GsIn,Gi),
...
:- true pred new_function_CIs(_A,_1,_2,_3,_B,CIl,CIlOut)
   : ( (CIl=[]),
       mshare([[_B],[CIlOut]]),
       ground([_A,_1,_2,_3]), linear(CIlOut) )
   => ground([_A,_1,_2,_3,_B,CIlOut]).

:- true pred new_function_CIs(_A,_1,_2,_3,_B,CIl,CIlOut)
   : ( mshare([[_B],[CIlOut]]),
       ground([_A,_1,_2,_3,CIl]), linear(CIlOut) )
   => ground([_A,_1,_2,_3,_B,CIl,CIlOut]).
...
new_function_CIs([function(K,Tk,Fk,CIk,IPk,ISk,Pk,Sk)|GsIn],L,Fl,NumVars,[function(K,Tk,Fk,CIko,IPk,ISk,Pk,Sk)|GsOut],CIlIn,CIlOut) :-
    true((mshare([[CIlOut],[GsOut],[GsOut,CIko],[CIko]]),ground([L,Fl,NumVars,CIlIn,GsIn,K,Tk,Fk,CIk,IPk,ISk,Pk,Sk]);mshare([[CIlOut],[GsOut],[GsOut,CIko],[CIko]]),ground([L,Fl,NumVars,CIlIn,GsIn,K,Tk,Fk,CIk,IPk,ISk,Pk,Sk]),linear(CIlOut))),
...
new_function_CIs([Gk|GsIn],L,Fl,NumVars,[Gk|GsOut],CIlIn,CIlOut) :-
    true((mshare([[CIlOut],[GsOut]]),ground([L,Fl,NumVars,CIlIn,Gk,GsIn]);mshare([[CIlOut],[GsOut]]),ground([L,Fl,NumVars,CIlIn,Gk,GsIn]),linear(CIlOut))),
...
function(I,[Gi|_1],Gi) :-
    ...
    true(ground([I,Gi,_1])).
function(I,[_1|Gs],Gi) :-
    true((mshare([[Gi]]),ground([I,_1,Gs]);mshare([[Gi]]),ground([I,_1,Gs]),linear(Gi))),
    function(I,Gs,Gi),
