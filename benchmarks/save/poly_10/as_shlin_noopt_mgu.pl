...
poly_add(poly(Var,Terms1),poly(Var,Terms2),poly(Var,Terms)) :-
    !,
    true((mshare([[Terms]]),ground([Var,Terms1,Terms2]);mshare([[Terms]]),ground([Var,Terms1,Terms2]),linear(Terms))),
...
poly_add(poly(Var1,Terms1),poly(Var2,Terms2),poly(Var1,Terms)) :-
    true((mshare([[Terms]]),ground([Var1,Terms1,Var2,Terms2]);mshare([[Terms]]),ground([Var1,Terms1,Var2,Terms2]),linear(Terms))),
    Var1 less_than Var2,
    !,
    true((
        mshare([[Terms]]),
...
poly_add(Poly,poly(Var,Terms2),poly(Var,Terms)) :-
    !,
    true((mshare([[Terms]]),ground([Poly,Var,Terms2]);mshare([[Terms]]),ground([Poly,Var,Terms2]),linear(Terms))),
    add_to_order_zero_term(Terms2,Poly,Terms),
    true(ground([Poly,Var,Terms2,Terms])).
poly_add(poly(Var,Terms1),C,poly(Var,Terms)) :-
    !,
    true((mshare([[Terms]]),ground([C,Var,Terms1]);mshare([[Terms]]),ground([C,Var,Terms1]),linear(Terms))),
    add_to_order_zero_term(Terms1,C,Terms),
    true(ground([C,Var,Terms1,Terms])).
poly_add(C1,C2,C) :-
    true((mshare([[C]]),ground([C1,C2]);mshare([[C]]),ground([C1,C2]),linear(C))),
    C is C1+C2,
    true(ground([C1,C2,C])).
...
term_add([term(E,C1)|Terms1],[term(E,C2)|Terms2],[term(E,C)|Terms]) :-
    !,
    true((mshare([[Terms],[Terms,C],[C]]),ground([Terms1,E,C1,Terms2,C2]);mshare([[Terms],[C]]),ground([Terms1,E,C1,Terms2,C2]),linear(Terms),linear(C))),
    poly_add(C1,C2,C),
    true((
        mshare([[Terms]]),
...
term_add([term(E1,C1)|Terms1],[term(E2,C2)|Terms2],[term(E1,C1)|Terms]) :-
    true((mshare([[Terms]]),ground([Terms1,E1,C1,Terms2,E2,C2]);mshare([[Terms]]),ground([Terms1,E1,C1,Terms2,E2,C2]),linear(Terms))),
    E1<E2,
    !,
    true((mshare([[Terms]]),ground([Terms1,E1,C1,Terms2,E2,C2]);mshare([[Terms]]),ground([Terms1,E1,C1,Terms2,E2,C2]),linear(Terms))),
...
term_add(Terms1,[term(E2,C2)|Terms2],[term(E2,C2)|Terms]) :-
    true((mshare([[Terms]]),ground([Terms1,Terms2,E2,C2]);mshare([[Terms]]),ground([Terms1,Terms2,E2,C2]),linear(Terms))),
    term_add(Terms1,Terms2,Terms),
...
add_to_order_zero_term([term(0,C1)|Terms],C2,[term(0,C)|Terms]) :-
    !,
    true((mshare([[C]]),ground([C2,Terms,C1]);mshare([[C]]),ground([C2,Terms,C1]),linear(C))),
    poly_add(C1,C2,C),
...
poly_exp(N,Poly,Result) :-
    true((mshare([[Result],[M],[Part]]),ground([N,Poly]),linear(Result),linear(M),linear(Part);mshare([[Result],[M],[Part]]),ground([N,Poly]),linear(M),linear(Part))),
    M is N>>1,
    true((mshare([[Result],[Part]]),ground([N,Poly,M]),linear(Result),linear(Part);mshare([[Result],[Part]]),ground([N,Poly,M]),linear(Part))),
    N is M<<1,
    !,
    true((mshare([[Result],[Part]]),ground([N,Poly,M]),linear(Result),linear(Part);mshare([[Result],[Part]]),ground([N,Poly,M]),linear(Part))),
...
poly_mul(P,poly(Var,Terms2),poly(Var,Terms)) :-
    !,
    true((mshare([[Terms]]),ground([P,Var,Terms2]);mshare([[Terms]]),ground([P,Var,Terms2]),linear(Terms))),
...
term_mul([Term|Terms1],Terms2,Terms) :-
    true((mshare([[Terms],[PartA],[PartB]]),ground([Terms2,Term,Terms1]),linear(Terms),linear(PartA),linear(PartB);mshare([[Terms],[PartA],[PartB]]),ground([Terms2,Term,Terms1]),linear(PartA),linear(PartB))),
...
single_term_mul([term(E1,C1)|Terms1],term(E2,C2),[term(E,C)|Terms]) :-
    true((mshare([[Terms],[Terms,E],[Terms,E,C],[Terms,C],[E],[E,C],[C]]),ground([Terms1,E1,C1,E2,C2]);mshare([[Terms],[E],[C]]),ground([Terms1,E1,C1,E2,C2]),linear(Terms),linear(E),linear(C))),
    E is E1+E2,
    true((mshare([[Terms],[Terms,C],[C]]),ground([Terms1,E1,C1,E2,C2,E]);mshare([[Terms],[C]]),ground([Terms1,E1,C1,E2,C2,E]),linear(Terms),linear(C))),
    poly_mul(C1,C2,C),
    true((
        mshare([[Terms]]),
...
mul_through([term(E,Term)|Terms],Poly,[term(E,NewTerm)|NewTerms]) :-
    true((mshare([[NewTerms],[NewTerms,NewTerm],[NewTerm]]),ground([Poly,Terms,E,Term]);mshare([[NewTerms],[NewTerm]]),ground([Poly,Terms,E,Term]),linear(NewTerms),linear(NewTerm))),
