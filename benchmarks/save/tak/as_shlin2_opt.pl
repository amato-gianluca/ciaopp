...
:- true pred tak(X,Y,Z,A)
   : ( mshare([[A]]),
       ground([X,Y,Z]), linear(A), shlin2([([A],[A])]) )
   => ground([X,Y,Z,A]).
...
tak(X,Y,Z,A) :-
    true((
        ...
        linear(Z1),
        linear(A3),
        shlin2([([A],[A]),([X1],[X1]),([A1],[A1]),([Y1],[Y1]),([A2],[A2]),([Z1],[Z1]),([A3],[A3])])
    )),
    X>Y,
    true((
        mshare([[A],[X1],[A1],[Y1],[A2],[Z1],[A3]]),
    ...
    true((
        ...
        linear(Z1),
        linear(A3),
        shlin2([([A],[A]),([A1],[A1]),([Y1],[Y1]),([A2],[A2]),([Z1],[Z1]),([A3],[A3])])
    )),
    tak(X1,Y,Z,A1),
    true((
        ...
        linear(Z1),
        linear(A3),
        shlin2([([A],[A]),([Y1],[Y1]),([A2],[A2]),([Z1],[Z1]),([A3],[A3])])
    )),
    Y1 is Y-1,
    true((
        mshare([[A],[A2],[Z1],[A3]]),
