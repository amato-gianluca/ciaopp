...
ciaopp  -o as_shlin_opt.pl -A shlin_experiments.pl -fmodes=as_shlin -ftypes=none -fcollapse_ai_vers=off -fpp_info=on
ciaopp  -o as_shlin_noopt.pl -A shlin_experiments.pl -fmodes=as_shlin -ftypes=none -fcollapse_ai_vers=off -fpp_info=on -fmgu_shlin_noindcheck=off
