...
ciaopp  -o as_shlin_opt.pl -A shlin_experiments.pl -fmodes=as_shlin -ftypes=none -fcollapse_ai_vers=off -fpp_info=on -fmgu_shlin_optimize=optimal
ciaopp  -o as_shlin_noindcheck.pl -A shlin_experiments.pl -fmodes=as_shlin -ftypes=none -fcollapse_ai_vers=off -fpp_info=on -fmgu_shlin_optimize=noindcheck
