...
example3(X,X1,X2,Y,Y1,Y2,Z) :-
    true(mshare([[X,X1],[X,X1,X2],[X,X1,X2,Y,Y1,Y2,Z],[X,X1,X2,Y,Y1,Z],[X,X1,X2,Y,Y2,Z],[X,X1,X2,Y,Z],[X,X1,Y,Y1,Y2,Z],[X,X1,Y,Y1,Z],[X,X1,Y,Y2,Z],[X,X1,Y,Z],[X,X2],[X,X2,Y,Y1,Y2,Z],[X,X2,Y,Y1,Z],[X,X2,Y,Y2,Z],[X,X2,Y,Z],[X,Y,Y1,Y2,Z],[X,Y,Y1,Z],[X,Y,Y2,Z],[X,Y,Z],[Y,Y1],[Y,Y1,Y2],[Y,Y2]])),
    X=Y,
