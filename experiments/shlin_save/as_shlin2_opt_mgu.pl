...
:- true pred example3(X,X1,X2,Y,Y1,Y2,Z)
   ...
   => ( mshare([[X,X1,Y,Y1],[X,X1,Y,Y1,Z],[X,X1,Y,Y2],[X,X1,Y,Y2,Z],[X,X2,Y,Y1],[X,X2,Y,Y1,Z],[X,X2,Y,Y2],[X,X2,Y,Y2,Z]]),
        linear(X1), linear(X2), linear(Y1), linear(Y2), shlin2([([X,X1,Y,Y1],[X,X1,Y,Y1]),([X,X1,Y,Y1,Z],[X1,Y1]),([X,X1,Y,Y2],[X,X1,Y,Y2]),([X,X1,Y,Y2,Z],[X1,Y2]),([X,X2,Y,Y1],[X,X2,Y,Y1]),([X,X2,Y,Y1,Z],[X2,Y1]),([X,X2,Y,Y2],[X,X2,Y,Y2]),([X,X2,Y,Y2,Z],[X2,Y2])]) ).
...
example3(X,X1,X2,Y,Y1,Y2,Z) :-
    ...
    true((
        ...
        linear(Y1),
        linear(Y2),
        shlin2([([X,X1,Y,Y1],[X,X1,Y,Y1]),([X,X1,Y,Y1,Z],[X1,Y1]),([X,X1,Y,Y2],[X,X1,Y,Y2]),([X,X1,Y,Y2,Z],[X1,Y2]),([X,X2,Y,Y1],[X,X2,Y,Y1]),([X,X2,Y,Y1,Z],[X2,Y1]),([X,X2,Y,Y2],[X,X2,Y,Y2]),([X,X2,Y,Y2,Z],[X2,Y2])])
    )),
    nothing,
    true((
        mshare([[X,X1,Y,Y1],[X,X1,Y,Y1,Z],[X,X1,Y,Y2],[X,X1,Y,Y2,Z],[X,X2,Y,Y1],[X,X2,Y,Y1,Z],[X,X2,Y,Y2],[X,X2,Y,Y2,Z]]),
...
:- true pred example4(V,W,X,Y,Z)
   ...
   => ( mshare([[V,W,X,Y,Z],[V,W,X,Z],[X,Y]]),
        linear(W), shlin2([([V,W,X,Y,Z],[W]),([V,W,X,Z],[W]),([X,Y],[])]) ).
...
example4(V,W,X,Y,Z) :-
    ...
    true((
        mshare([[V,W,X,Y,Z],[V,W,X,Z],[X,Y]]),
        linear(W),
        shlin2([([V,W,X,Y,Z],[W]),([V,W,X,Z],[W]),([X,Y],[])])
    )).
